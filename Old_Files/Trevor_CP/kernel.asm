...
801001be:	e8 ad 40 00 00       	call   80104270 <holdingsleep>
...
801001ff:	e8 6c 40 00 00       	call   80104270 <holdingsleep>
...
8010020f:	e8 1c 40 00 00       	call   80104230 <releasesleep>

  acquire(&bcache.lock);
80100214:	c7 04 24 c0 b5 10 80 	movl   $0x8010b5c0,(%esp)
8010021b:	e8 80 41 00 00       	call   801043a0 <acquire>
  b->refcnt--;
...
8010026b:	5d                   	pop    %ebp
  release(&bcache.lock);
8010026c:	e9 4f 42 00 00       	jmp    801044c0 <release>
    panic("brelse");
...
8010029d:	e8 fe 40 00 00       	call   801043a0 <acquire>
...
801002fe:	e8 bd 41 00 00       	call   801044c0 <release>
        ilock(ip);
80100303:	5a                   	pop    %edx
...
80100355:	e8 66 41 00 00       	call   801044c0 <release>
  ilock(ip);
8010035a:	58                   	pop    %eax
...
801003b0:	e8 eb 02 00 00       	call   801006a0 <cprintf>
  cprintf("\n");
801003b5:	c7 04 24 57 78 10 80 	movl   $0x80107857,(%esp)
...
801003c8:	e8 f3 3e 00 00       	call   801042c0 <getcallerpcs>
  for(i=0; i<10; i++)
...
80100551:	e8 5a 40 00 00       	call   801045b0 <memmove>
    memset(crt+pos, 0, sizeof(crt[0])*(24*80 - pos));
...
80100566:	e8 a5 3f 00 00       	call   80104510 <memset>
...
8010064b:	e8 50 3d 00 00       	call   801043a0 <acquire>
  for(i = 0; i < n; i++)
...
80100687:	e8 34 3e 00 00       	call   801044c0 <release>
  ilock(ip);
8010068c:	58                   	pop    %eax
...
801007a5:	e8 f6 3b 00 00       	call   801043a0 <acquire>
...
80100818:	e8 a3 3c 00 00       	call   801044c0 <release>
...
80100863:	e8 38 3b 00 00       	call   801043a0 <acquire>
  while((c = getc()) >= 0){
...
801009bf:	e8 fc 3a 00 00       	call   801044c0 <release>
  if(doprocdump) {
...
80100a30:	e8 6b 38 00 00       	call   801042a0 <initlock>
...
80100c93:	e8 78 3a 00 00       	call   80104710 <strlen>
...
80100ca6:	e8 65 3a 00 00       	call   80104710 <strlen>
...
80100d61:	e8 6a 39 00 00       	call   801046d0 <safestrcpy>
  curproc->pgdir = pgdir;
...
80100de0:	e8 bb 34 00 00       	call   801042a0 <initlock>
}
...
80100e01:	e8 9a 35 00 00       	call   801043a0 <acquire>
...
80100e31:	e8 8a 36 00 00       	call   801044c0 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100e4a:	e8 71 36 00 00       	call   801044c0 <release>
}
...
80100e6f:	e8 2c 35 00 00       	call   801043a0 <acquire>
  if(f->ref < 1)
...
80100e8c:	e8 2f 36 00 00       	call   801044c0 <release>
  return f;
}
...
80100ec1:	e8 da 34 00 00       	call   801043a0 <acquire>
  if(f->ref < 1)
...
80100ef9:	89 45 e0             	mov    %eax,-0x20(%ebp)
  release(&ftable.lock);
80100efc:	e8 bf 35 00 00       	call   801044c0 <release>
...
80100f2d:	5d                   	pop    %ebp
    release(&ftable.lock);
80100f2e:	e9 8d 35 00 00       	jmp    801044c0 <release>
...
80101317:	e8 a4 31 00 00       	call   801044c0 <release>
...
80101342:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
80101345:	e8 76 31 00 00       	call   801044c0 <release>
      return ip;
...
80101471:	e8 3a 31 00 00       	call   801045b0 <memmove>
  brelse(bp);
...
80101526:	e8 75 2d 00 00       	call   801042a0 <initlock>
  for(i = 0; i < NINODE; i++) {
...
8010153f:	e8 4c 2c 00 00       	call   80104190 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
8010161e:	e8 ed 2e 00 00       	call   80104510 <memset>
      dip->type = type;
...
801016c1:	e8 ea 2e 00 00       	call   801045b0 <memmove>
  log_write(bp);
...
801016ef:	e8 ac 2c 00 00       	call   801043a0 <acquire>
  ip->ref++;
801016f4:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
801016f8:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
801016ff:	e8 bc 2d 00 00       	call   801044c0 <release>
}
...
80101732:	e8 99 2a 00 00       	call   801041d0 <acquiresleep>
  if(ip->valid == 0){
...
801017a8:	e8 03 2e 00 00       	call   801045b0 <memmove>
    brelse(bp);
...
80101803:	e8 68 2a 00 00       	call   80104270 <holdingsleep>
...
8010181e:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
8010181f:	e9 0c 2a 00 00       	jmp    80104230 <releasesleep>
    panic("iunlock");
...
80101850:	e8 7b 29 00 00       	call   801041d0 <acquiresleep>
...
8010186a:	e8 c1 29 00 00       	call   80104230 <releasesleep>
  acquire(&icache.lock);
8010186f:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101876:	e8 25 2b 00 00       	call   801043a0 <acquire>
  ip->ref--;
...
80101a97:	e8 14 2b 00 00       	call   801045b0 <memmove>
    brelse(bp);
...
80101b93:	e8 18 2a 00 00       	call   801045b0 <memmove>
    log_write(bp);
...
80101c2e:	e8 ed 29 00 00       	call   80104620 <strncmp>
}
80101c33:	c9                   	leave  
80101c34:	c3                   	ret    
...
80101c8d:	e8 8e 29 00 00       	call   80104620 <strncmp>
      continue;
...
80101d1c:	e8 7f 26 00 00       	call   801043a0 <acquire>
  ip->ref++;
80101d21:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101d25:	c7 04 24 e0 09 11 80 	movl   $0x801109e0,(%esp)
80101d2c:	e8 8f 27 00 00       	call   801044c0 <release>
...
80101d97:	e8 14 28 00 00       	call   801045b0 <memmove>
...
80101e23:	e8 88 27 00 00       	call   801045b0 <memmove>
    name[len] = 0;
...
80101f4d:	e8 1e 27 00 00       	call   80104670 <strncpy>
...
80101f98:	68 3e 76 10 80       	push   $0x8010763e
...
801020e0:	e8 bb 21 00 00       	call   801042a0 <initlock>
...
8010215e:	e8 3d 22 00 00       	call   801043a0 <acquire>
...
801021db:	e8 e0 22 00 00       	call   801044c0 <release>
...
801021fe:	e8 6d 20 00 00       	call   80104270 <holdingsleep>
...
80102238:	e8 63 21 00 00       	call   801043a0 <acquire>
...
80102438:	e8 63 1f 00 00       	call   801043a0 <acquire>
...
80102452:	c9                   	leave  
    release(&kmem.lock);
80102453:	e9 68 20 00 00       	jmp    801044c0 <release>
    panic("kfree");
...
801024d5:	e8 c6 1d 00 00       	call   801042a0 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
801025c3:	e8 d8 1d 00 00       	call   801043a0 <acquire>
  r = kmem.freelist;
...
801025f1:	e8 ca 1e 00 00       	call   801044c0 <release>
  return (char*)r;
...
80102a07:	e8 54 1b 00 00       	call   80104560 <memcmp>
...
80102b34:	e8 77 1a 00 00       	call   801045b0 <memmove>
...
80102be4:	e8 b7 16 00 00       	call   801042a0 <initlock>
  readsb(dev, &sb);
80102be9:	58                   	pop    %eax
...
80102c7b:	e8 20 17 00 00       	call   801043a0 <acquire>
...
80102ccc:	e8 ef 17 00 00       	call   801044c0 <release>
      break;
    }
  }
}
...
80102cee:	e8 ad 16 00 00       	call   801043a0 <acquire>
  log.outstanding -= 1;
...
80102d2c:	e8 8f 17 00 00       	call   801044c0 <release>
}
...
80102d46:	e8 55 16 00 00       	call   801043a0 <acquire>
    wakeup(&log);
...
80102d68:	e8 53 17 00 00       	call   801044c0 <release>
...
80102dc4:	e8 e7 17 00 00       	call   801045b0 <memmove>
...
80102e24:	e8 97 16 00 00       	call   801044c0 <release>
...
80102e86:	e8 15 15 00 00       	call   801043a0 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102ec4:	c9                   	leave  
  release(&log.lock);
80102ec5:	e9 f6 15 00 00       	jmp    801044c0 <release>
...
80102fe4:	e8 c7 15 00 00       	call   801045b0 <memmove>
...
801030d4:	e8 87 14 00 00       	call   80104560 <memcmp>
...
8010318c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(memcmp(conf, "PCMP", 4) != 0)
8010318f:	e8 cc 13 00 00       	call   80104560 <memcmp>
...
80103389:	e8 12 0f 00 00       	call   801042a0 <initlock>
  (*f0)->type = FD_PIPE;
...
8010341f:	e8 7c 0f 00 00       	call   801043a0 <acquire>
  if(writable){
...
801034bd:	e8 de 0e 00 00       	call   801043a0 <acquire>
  for(i = 0; i < n; i++){
...
8010354c:	e8 6f 0f 00 00       	call   801044c0 <release>
        return -1;
...
801035a2:	e8 19 0f 00 00       	call   801044c0 <release>
  return n;
...
801035c6:	e8 d5 0d 00 00       	call   801043a0 <acquire>
...
8010365e:	e8 5d 0e 00 00       	call   801044c0 <release>
  return i;
...
80103679:	e8 42 0e 00 00       	call   801044c0 <release>
      return -1;
...
801036a1:	e8 fa 0c 00 00       	call   801043a0 <acquire>
...
801036e0:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
801036e6:	e8 d5 0d 00 00       	call   801044c0 <release>
...
80103708:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010370b:	c7 40 14 a2 56 10 80 	movl   $0x801056a2,0x14(%eax)
  p->context = (struct context*)sp;
...
8010371a:	e8 f1 0d 00 00       	call   80104510 <memset>
...
8010374a:	e8 71 0d 00 00       	call   801044c0 <release>
}
...
8010377b:	e8 40 0d 00 00       	call   801044c0 <release>
...
801037c6:	68 00 74 10 80       	push   $0x80107400
...
80103874:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103877:	e8 d4 0a 00 00       	call   80104350 <pushcli>
  c = mycpu();
8010387c:	e8 5f ff ff ff       	call   801037e0 <mycpu>
  p = c->proc;
80103881:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103887:	e8 d4 0b 00 00       	call   80104460 <popcli>
}
...
801038b3:	e8 88 33 00 00       	call   80106c40 <setupkvm>
...
801038d1:	e8 4a 30 00 00       	call   80106920 <inituvm>
...
801038e6:	e8 25 0c 00 00       	call   80104510 <memset>
...
8010393f:	68 30 74 10 80       	push   $0x80107430
80103944:	50                   	push   %eax
80103945:	e8 86 0d 00 00       	call   801046d0 <safestrcpy>
  p->cwd = namei("/");
8010394a:	c7 04 24 39 74 10 80 	movl   $0x80107439,(%esp)
...
80103983:	68 17 74 10 80       	push   $0x80107417
...
80103995:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103998:	e8 b3 09 00 00       	call   80104350 <pushcli>
  c = mycpu();
...
801039bb:	e8 50 2e 00 00       	call   80106810 <switchuvm>
  return 0;
...
801039da:	e8 81 30 00 00       	call   80106a60 <allocuvm>
...
801039fa:	e8 91 31 00 00       	call   80106b90 <deallocuvm>
...
80103a16:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103a19:	e8 32 09 00 00       	call   80104350 <pushcli>
  c = mycpu();
...
80103a48:	e8 c3 32 00 00       	call   80106d10 <copyuvm>
...
80103b5e:	e8 3d 08 00 00       	call   801043a0 <acquire>
...
80103b80:	e8 8b 2c 00 00       	call   80106810 <switchuvm>
...
80103b8b:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103b92:	e8 94 0b 00 00       	call   8010472b <swtch>
      switchkvm();
80103b97:	e8 64 2c 00 00       	call   80106800 <switchkvm>
      c->proc = 0;
...
80103bbc:	e8 ff 08 00 00       	call   801044c0 <release>
    sti();
...
80103c33:	e8 f3 0a 00 00       	call   8010472b <swtch>
  mycpu()->intena = intena;
...
80103c96:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103c99:	e8 b2 06 00 00       	call   80104350 <pushcli>
  c = mycpu();
80103c9e:	e8 3d fb ff ff       	call   801037e0 <mycpu>
  p = c->proc;
80103ca3:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103ca9:	e8 b2 07 00 00       	call   80104460 <popcli>
  if(curproc == initproc)
...
80103d02:	e8 99 06 00 00       	call   801043a0 <acquire>
...
80103d9d:	68 88 74 10 80       	push   $0x80107488
80103da2:	e8 d9 c5 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103da7:	83 ec 0c             	sub    $0xc,%esp
80103daa:	68 7b 74 10 80       	push   $0x8010747b
...
80103dcc:	e8 cf 05 00 00       	call   801043a0 <acquire>
  pushcli();
80103dd1:	e8 7a 05 00 00       	call   80104350 <pushcli>
  c = mycpu();
80103dd6:	e8 05 fa ff ff       	call   801037e0 <mycpu>
  p = c->proc;
80103ddb:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103de1:	e8 7a 06 00 00       	call   80104460 <popcli>
...
80103df9:	e8 c2 06 00 00       	call   801044c0 <release>
}
...
80103e1c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103e1f:	e8 2c 05 00 00       	call   80104350 <pushcli>
  c = mycpu();
80103e24:	e8 b7 f9 ff ff       	call   801037e0 <mycpu>
  p = c->proc;
80103e29:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103e2f:	e8 2c 06 00 00       	call   80104460 <popcli>
  if(p == 0)
...
80103e50:	e8 4b 05 00 00       	call   801043a0 <acquire>
    release(lk);
80103e55:	89 34 24             	mov    %esi,(%esp)
80103e58:	e8 63 06 00 00       	call   801044c0 <release>
  p->chan = chan;
...
80103e7a:	e8 41 06 00 00       	call   801044c0 <release>
    acquire(lk);
...
80103e8b:	5d                   	pop    %ebp
    acquire(lk);
80103e8c:	e9 0f 05 00 00       	jmp    801043a0 <acquire>
...
80103eb9:	68 9a 74 10 80       	push   $0x8010749a
80103ebe:	e8 bd c4 ff ff       	call   80100380 <panic>
    panic("sleep");
80103ec3:	83 ec 0c             	sub    $0xc,%esp
80103ec6:	68 94 74 10 80       	push   $0x80107494
...
80103f62:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103f69:	e8 52 2c 00 00       	call   80106bc0 <freevm>
        release(&ptable.lock);
...
80103f8e:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103f95:	e8 26 05 00 00       	call   801044c0 <release>
        return pid;
...
80104010:	c9                   	leave  
  release(&ptable.lock);
80104011:	e9 aa 04 00 00       	jmp    801044c0 <release>
...
8010402f:	e8 6c 03 00 00       	call   801043a0 <acquire>
...
8010406b:	e8 50 04 00 00       	call   801044c0 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
80104088:	e8 33 04 00 00       	call   801044c0 <release>
}
...
801040ae:	83 ec 48             	sub    $0x48,%esp
  ...
  uint pc[10];
  cprintf("\n");
801040b1:	68 57 78 10 80       	push   $0x80107857
801040b6:	e8 e5 c5 ff ff       	call   801006a0 <cprintf>
  cprintf("PID \t Name \t Elapsed \tState \t Size \tPCs \t\n");
801040bb:	c7 04 24 18 75 10 80 	movl   $0x80107518,(%esp)
801040c2:	e8 d9 c5 ff ff       	call   801006a0 <cprintf>

  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801040c7:	83 c4 10             	add    $0x10,%esp
801040ca:	eb 23                	jmp    801040ef <procdump+0x4f>
...
801040d3:	68 57 78 10 80       	push   $0x80107857
801040d8:	e8 c3 c5 ff ff       	call   801006a0 <cprintf>
801040dd:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801040e0:	83 eb 80             	sub    $0xffffff80,%ebx
801040e3:	81 fb c0 4d 11 80    	cmp    $0x80114dc0,%ebx
801040e9:	0f 84 91 00 00 00    	je     80104180 <procdump+0xe0>
    if(p->state == UNUSED)
801040ef:	8b 43 a0             	mov    -0x60(%ebx),%eax
801040f2:	85 c0                	test   %eax,%eax
801040f4:	74 ea                	je     801040e0 <procdump+0x40>
      state = "???";
801040f6:	ba ab 74 10 80       	mov    $0x801074ab,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801040fb:	83 f8 05             	cmp    $0x5,%eax
801040fe:	77 11                	ja     80104111 <procdump+0x71>
80104100:	8b 14 85 44 75 10 80 	mov    -0x7fef8abc(,%eax,4),%edx
      state = "???";
80104107:	b8 ab 74 10 80       	mov    $0x801074ab,%eax
8010410c:	85 d2                	test   %edx,%edx
8010410e:	0f 44 d0             	cmove  %eax,%edx
    cprintf("%d \t%s \t %d \t %s \t %d",p->pid, p->name,(ticks - p->start_ticks), state, p->sz);
80104111:	83 ec 08             	sub    $0x8,%esp
80104114:	a1 a0 55 11 80       	mov    0x801155a0,%eax
80104119:	2b 43 10             	sub    0x10(%ebx),%eax
8010411c:	ff 73 94             	pushl  -0x6c(%ebx)
8010411f:	52                   	push   %edx
80104120:	50                   	push   %eax
80104121:	53                   	push   %ebx
80104122:	ff 73 a4             	pushl  -0x5c(%ebx)
80104125:	68 af 74 10 80       	push   $0x801074af
8010412a:	e8 71 c5 ff ff       	call   801006a0 <cprintf>
    if(p->state == SLEEPING){
8010412f:	83 c4 20             	add    $0x20,%esp
80104132:	83 7b a0 02          	cmpl   $0x2,-0x60(%ebx)
80104136:	75 98                	jne    801040d0 <procdump+0x30>
      getcallerpcs((uint*)p->context->ebp+2, pc);
80104138:	83 ec 08             	sub    $0x8,%esp
8010413b:	8d 45 c0             	lea    -0x40(%ebp),%eax
8010413e:	8d 7d c0             	lea    -0x40(%ebp),%edi
80104141:	50                   	push   %eax
80104142:	8b 43 b0             	mov    -0x50(%ebx),%eax
80104145:	8b 40 0c             	mov    0xc(%eax),%eax
80104148:	83 c0 08             	add    $0x8,%eax
8010414b:	50                   	push   %eax
8010414c:	e8 6f 01 00 00       	call   801042c0 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
8010415c:	0f 84 6e ff ff ff    	je     801040d0 <procdump+0x30>
        cprintf(" %p", pc[i]);
80104162:	83 ec 08             	sub    $0x8,%esp
80104165:	83 c7 04             	add    $0x4,%edi
80104168:	52                   	push   %edx
80104169:	68 01 6f 10 80       	push   $0x80106f01
8010416e:	e8 2d c5 ff ff       	call   801006a0 <cprintf>
      for(i=0; i<10 && pc[i] != 0; i++)
80104173:	83 c4 10             	add    $0x10,%esp
80104176:	39 fe                	cmp    %edi,%esi
80104178:	75 de                	jne    80104158 <procdump+0xb8>
8010417a:	e9 51 ff ff ff       	jmp    801040d0 <procdump+0x30>
8010417f:	90                   	nop
  }
}
...
8010419a:	68 5c 75 10 80       	push   $0x8010755c
...
801041c1:	c9                   	leave  
801041c2:	c3                   	ret    
801041c3:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
801041d5:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&lk->lk);
801041d8:	8d 73 04             	lea    0x4(%ebx),%esi
...
801041f5:	e8 16 fc ff ff       	call   80103e10 <sleep>
  while (lk->locked) {
...
80104254:	e8 67 fd ff ff       	call   80103fc0 <wakeup>
  release(&lk->lk);
...
80104275:	8b 75 08             	mov    0x8(%ebp),%esi
  ...
  acquire(&lk->lk);
80104278:	8d 5e 04             	lea    0x4(%esi),%ebx
...
801042fb:	8d 51 28             	lea    0x28(%ecx),%edx
...
8010431a:	8b 02                	mov    (%edx),%eax
8010431c:	85 c0                	test   %eax,%eax
8010431e:	75 10                	jne    80104330 <holding+0x20>
}
...
8010432f:	90                   	nop
  return lock->locked && lock->cpu == mycpu();
80104330:	8b 5a 08             	mov    0x8(%edx),%ebx
80104333:	e8 a8 f4 ff ff       	call   801037e0 <mycpu>
80104338:	39 c3                	cmp    %eax,%ebx
...
80104367:	74 17                	je     80104380 <pushcli+0x30>
    mycpu()->intena = eflags & FL_IF;
  mycpu()->ncli += 1;
80104369:	e8 72 f4 ff ff       	call   801037e0 <mycpu>
8010436e:	83 80 a4 00 00 00 01 	addl   $0x1,0xa4(%eax)
}
...
80104385:	81 e3 00 02 00 00    	and    $0x200,%ebx
8010438b:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
80104391:	eb d6                	jmp    80104369 <pushcli+0x19>
...
801043a5:	e8 a6 ff ff ff       	call   80104350 <pushcli>
  if(holding(lk))
...
801043d4:	e8 07 f4 ff ff       	call   801037e0 <mycpu>
  ebp = (uint*)v - 2;
801043d9:	89 ea                	mov    %ebp,%edx
  lk->cpu = mycpu();
801043db:	89 43 08             	mov    %eax,0x8(%ebx)
  for(i = 0; i < 10; i++){
801043de:	31 c0                	xor    %eax,%eax
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
801043e0:	8d 8a 00 00 00 80    	lea    -0x80000000(%edx),%ecx
801043e6:	81 f9 fe ff ff 7f    	cmp    $0x7ffffffe,%ecx
801043ec:	77 22                	ja     80104410 <acquire+0x70>
    pcs[i] = ebp[1];     // saved %eip
801043ee:	8b 4a 04             	mov    0x4(%edx),%ecx
801043f1:	89 4c 83 0c          	mov    %ecx,0xc(%ebx,%eax,4)
  for(i = 0; i < 10; i++){
801043f5:	83 c0 01             	add    $0x1,%eax
    ebp = (uint*)ebp[0]; // saved %ebp
801043f8:	8b 12                	mov    (%edx),%edx
  for(i = 0; i < 10; i++){
801043fa:	83 f8 0a             	cmp    $0xa,%eax
801043fd:	75 e1                	jne    801043e0 <acquire+0x40>
}
...
8010440d:	8d 76 00             	lea    0x0(%esi),%esi
  for(; i < 10; i++)
80104410:	8d 44 83 0c          	lea    0xc(%ebx,%eax,4),%eax
80104414:	83 c3 34             	add    $0x34,%ebx
...
8010443b:	e8 a0 f3 ff ff       	call   801037e0 <mycpu>
80104440:	39 c6                	cmp    %eax,%esi
80104442:	0f 85 6f ff ff ff    	jne    801043b7 <acquire+0x17>
    panic("acquire");
80104448:	83 ec 0c             	sub    $0xc,%esp
8010444b:	68 67 75 10 80       	push   $0x80107567
80104450:	e8 2b bf ff ff       	call   80100380 <panic>
...
8010448c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
80104490:	e8 4b f3 ff ff       	call   801037e0 <mycpu>
...
801044a5:	68 6f 75 10 80       	push   $0x8010756f
801044aa:	e8 d1 be ff ff       	call   80100380 <panic>
    panic("popcli");
801044af:	83 ec 0c             	sub    $0xc,%esp
801044b2:	68 86 75 10 80       	push   $0x80107586
801044b7:	e8 c4 be ff ff       	call   80100380 <panic>
...
8010450a:	5d                   	pop    %ebp
  popcli();
8010450b:	e9 50 ff ff ff       	jmp    80104460 <popcli>
...
80104520:	09 cf                	or     %ecx,%edi
80104522:	83 e7 03             	and    $0x3,%edi
80104525:	75 29                	jne    80104550 <memset+0x40>
    c &= 0xFF;
80104527:	0f b6 f8             	movzbl %al,%edi
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
8010452a:	c1 e0 18             	shl    $0x18,%eax
8010452d:	89 fb                	mov    %edi,%ebx
8010452f:	c1 e9 02             	shr    $0x2,%ecx
80104532:	c1 e3 10             	shl    $0x10,%ebx
80104535:	09 d8                	or     %ebx,%eax
80104537:	09 f8                	or     %edi,%eax
80104539:	c1 e7 08             	shl    $0x8,%edi
8010453c:	09 f8                	or     %edi,%eax
  asm volatile("cld; rep stosl" :
8010453e:	89 d7                	mov    %edx,%edi
80104540:	fc                   	cld    
80104541:	f3 ab                	rep stos %eax,%es:(%edi)
  } else
    stosb(dst, c, n);
  return dst;
}
80104543:	5b                   	pop    %ebx
80104544:	89 d0                	mov    %edx,%eax
80104546:	5f                   	pop    %edi
80104547:	5d                   	pop    %ebp
80104548:	c3                   	ret    
80104549:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  asm volatile("cld; rep stosb" :
80104550:	89 d7                	mov    %edx,%edi
80104552:	fc                   	cld    
80104553:	f3 aa                	rep stos %al,%es:(%edi)
80104555:	5b                   	pop    %ebx
80104556:	89 d0                	mov    %edx,%eax
80104558:	5f                   	pop    %edi
80104559:	5d                   	pop    %ebp
8010455a:	c3                   	ret    
...
8010456b:	8b 45 0c             	mov    0xc(%ebp),%eax
  const uchar *s1, *s2;
...
80104570:	74 2e                	je     801045a0 <memcmp+0x40>
80104572:	01 c6                	add    %eax,%esi
80104574:	eb 14                	jmp    8010458a <memcmp+0x2a>
...
80104583:	83 c2 01             	add    $0x1,%edx
  while(n-- > 0){
80104586:	39 f0                	cmp    %esi,%eax
80104588:	74 16                	je     801045a0 <memcmp+0x40>
    if(*s1 != *s2)
8010458a:	0f b6 0a             	movzbl (%edx),%ecx
8010458d:	0f b6 18             	movzbl (%eax),%ebx
80104590:	38 d9                	cmp    %bl,%cl
80104592:	74 ec                	je     80104580 <memcmp+0x20>
      return *s1 - *s2;
80104594:	0f b6 c1             	movzbl %cl,%eax
80104597:	29 d8                	sub    %ebx,%eax
  }
...
801045bb:	8b 75 0c             	mov    0xc(%ebp),%esi
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
801045be:	39 d6                	cmp    %edx,%esi
801045c0:	73 26                	jae    801045e8 <memmove+0x38>
801045c2:	8d 3c 0e             	lea    (%esi,%ecx,1),%edi
801045c5:	39 fa                	cmp    %edi,%edx
801045c7:	73 1f                	jae    801045e8 <memmove+0x38>
801045c9:	8d 41 ff             	lea    -0x1(%ecx),%eax
    s += n;
    d += n;
    while(n-- > 0)
801045cc:	85 c9                	test   %ecx,%ecx
801045ce:	74 0f                	je     801045df <memmove+0x2f>
      *--d = *--s;
801045d0:	0f b6 0c 06          	movzbl (%esi,%eax,1),%ecx
801045d4:	88 0c 02             	mov    %cl,(%edx,%eax,1)
    while(n-- > 0)
801045d7:	83 e8 01             	sub    $0x1,%eax
801045da:	83 f8 ff             	cmp    $0xffffffff,%eax
...
801045e5:	8d 76 00             	lea    0x0(%esi),%esi
    while(n-- > 0)
801045e8:	8d 04 0e             	lea    (%esi,%ecx,1),%eax
801045eb:	89 d7                	mov    %edx,%edi
801045ed:	85 c9                	test   %ecx,%ecx
801045ef:	74 ee                	je     801045df <memmove+0x2f>
801045f1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      *d++ = *s++;
801045f8:	a4                   	movsb  %ds:(%esi),%es:(%edi)
    while(n-- > 0)
801045f9:	39 f0                	cmp    %esi,%eax
801045fb:	75 fb                	jne    801045f8 <memmove+0x48>
}
801045fd:	5e                   	pop    %esi
...
80104610:	eb 9e                	jmp    801045b0 <memmove>
...
80104627:	8b 4d 08             	mov    0x8(%ebp),%ecx
8010462a:	53                   	push   %ebx
8010462b:	8b 45 0c             	mov    0xc(%ebp),%eax
  while(n > 0 && *p && *p == *q)
8010462e:	85 f6                	test   %esi,%esi
80104630:	74 36                	je     80104668 <strncmp+0x48>
80104632:	01 c6                	add    %eax,%esi
80104634:	eb 18                	jmp    8010464e <strncmp+0x2e>
80104636:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010463d:	8d 76 00             	lea    0x0(%esi),%esi
80104640:	38 da                	cmp    %bl,%dl
80104642:	75 14                	jne    80104658 <strncmp+0x38>
    n--, p++, q++;
80104644:	83 c0 01             	add    $0x1,%eax
80104647:	83 c1 01             	add    $0x1,%ecx
  while(n > 0 && *p && *p == *q)
8010464a:	39 f0                	cmp    %esi,%eax
8010464c:	74 1a                	je     80104668 <strncmp+0x48>
8010464e:	0f b6 11             	movzbl (%ecx),%edx
80104651:	0f b6 18             	movzbl (%eax),%ebx
80104654:	84 d2                	test   %dl,%dl
80104656:	75 e8                	jne    80104640 <strncmp+0x20>
  if(n == 0)
    return 0;
  return (uchar)*p - (uchar)*q;
80104658:	0f b6 c2             	movzbl %dl,%eax
8010465b:	29 d8                	sub    %ebx,%eax
}
8010465d:	5b                   	pop    %ebx
8010465e:	5e                   	pop    %esi
8010465f:	5d                   	pop    %ebp
...
80104679:	8b 45 10             	mov    0x10(%ebp),%eax
  char *os;

  os = s;
  while(n-- > 0 && (*s++ = *t++) != 0)
8010467c:	89 f2                	mov    %esi,%edx
8010467e:	eb 17                	jmp    80104697 <strncpy+0x27>
80104680:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
80104684:	8b 7d 0c             	mov    0xc(%ebp),%edi
80104687:	83 c2 01             	add    $0x1,%edx
8010468a:	0f b6 7f ff          	movzbl -0x1(%edi),%edi
8010468e:	89 f9                	mov    %edi,%ecx
80104690:	88 4a ff             	mov    %cl,-0x1(%edx)
80104693:	84 c9                	test   %cl,%cl
80104695:	74 09                	je     801046a0 <strncpy+0x30>
80104697:	89 c3                	mov    %eax,%ebx
80104699:	83 e8 01             	sub    $0x1,%eax
8010469c:	85 db                	test   %ebx,%ebx
8010469e:	7f e0                	jg     80104680 <strncpy+0x10>
    ;
  while(n-- > 0)
801046a0:	89 d1                	mov    %edx,%ecx
801046a2:	85 c0                	test   %eax,%eax
801046a4:	7e 1d                	jle    801046c3 <strncpy+0x53>
801046a6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801046ad:	8d 76 00             	lea    0x0(%esi),%esi
    *s++ = 0;
801046b0:	83 c1 01             	add    $0x1,%ecx
801046b3:	c6 41 ff 00          	movb   $0x0,-0x1(%ecx)
  while(n-- > 0)
801046b7:	89 c8                	mov    %ecx,%eax
801046b9:	f7 d0                	not    %eax
801046bb:	01 d0                	add    %edx,%eax
801046bd:	01 d8                	add    %ebx,%eax
801046bf:	85 c0                	test   %eax,%eax
801046c1:	7f ed                	jg     801046b0 <strncpy+0x40>
  return os;
}
801046c3:	5b                   	pop    %ebx
801046c4:	89 f0                	mov    %esi,%eax
801046c6:	5e                   	pop    %esi
801046c7:	5f                   	pop    %edi
801046c8:	5d                   	pop    %ebp
801046c9:	c3                   	ret    
...
801046d4:	8b 55 10             	mov    0x10(%ebp),%edx
801046d7:	8b 75 08             	mov    0x8(%ebp),%esi
...
801046db:	8b 45 0c             	mov    0xc(%ebp),%eax
  ...
  os = s;
  if(n <= 0)
801046de:	85 d2                	test   %edx,%edx
801046e0:	7e 25                	jle    80104707 <safestrcpy+0x37>
801046e2:	8d 5c 10 ff          	lea    -0x1(%eax,%edx,1),%ebx
801046e6:	89 f2                	mov    %esi,%edx
801046e8:	eb 16                	jmp    80104700 <safestrcpy+0x30>
801046ea:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    return os;
  while(--n > 0 && (*s++ = *t++) != 0)
801046f0:	0f b6 08             	movzbl (%eax),%ecx
801046f3:	83 c0 01             	add    $0x1,%eax
801046f6:	83 c2 01             	add    $0x1,%edx
801046f9:	88 4a ff             	mov    %cl,-0x1(%edx)
801046fc:	84 c9                	test   %cl,%cl
801046fe:	74 04                	je     80104704 <safestrcpy+0x34>
80104700:	39 d8                	cmp    %ebx,%eax
80104702:	75 ec                	jne    801046f0 <safestrcpy+0x20>
    ;
  *s = 0;
80104704:	c6 02 00             	movb   $0x0,(%edx)
  return os;
}
...
80104791:	76 2d                	jbe    801047c0 <fetchstr+0x40>
    return -1;
  *pp = (char*)addr;
80104793:	8b 55 0c             	mov    0xc(%ebp),%edx
80104796:	89 1a                	mov    %ebx,(%edx)
  ep = (char*)curproc->sz;
80104798:	8b 10                	mov    (%eax),%edx
  for(s = *pp; s < ep; s++){
8010479a:	39 d3                	cmp    %edx,%ebx
8010479c:	73 22                	jae    801047c0 <fetchstr+0x40>
8010479e:	89 d8                	mov    %ebx,%eax
801047a0:	eb 0d                	jmp    801047af <fetchstr+0x2f>
801047a2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
801047a8:	83 c0 01             	add    $0x1,%eax
801047ab:	39 c2                	cmp    %eax,%edx
801047ad:	76 11                	jbe    801047c0 <fetchstr+0x40>
    if(*s == 0)
801047af:	80 38 00             	cmpb   $0x0,(%eax)
801047b2:	75 f4                	jne    801047a8 <fetchstr+0x28>
      return s - *pp;
  }
  return -1;
}
...
801047d5:	e8 96 f0 ff ff       	call   80103870 <myproc>
801047da:	8b 55 08             	mov    0x8(%ebp),%edx
801047dd:	8b 40 18             	mov    0x18(%eax),%eax
801047e0:	8b 40 44             	mov    0x44(%eax),%eax
801047e3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
801047e6:	e8 85 f0 ff ff       	call   80103870 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
801047eb:	8d 73 04             	lea    0x4(%ebx),%esi
  if(addr >= curproc->sz || addr+4 > curproc->sz)
801047ee:	8b 00                	mov    (%eax),%eax
...
80104828:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
8010482b:	e8 40 f0 ff ff       	call   80103870 <myproc>
 
  if(argint(n, &i) < 0)
80104830:	83 ec 08             	sub    $0x8,%esp
  struct proc *curproc = myproc();
80104833:	89 c6                	mov    %eax,%esi
  if(argint(n, &i) < 0)
...
801048a2:	e8 d9 fe ff ff       	call   80104780 <fetchstr>
...
801048c4:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
801048c7:	e8 a4 ef ff ff       	call   80103870 <myproc>
...
801048da:	77 24                	ja     80104900 <syscall+0x40>
801048dc:	8b 14 85 c0 75 10 80 	mov    -0x7fef8a40(,%eax,4),%edx
801048e3:	85 d2                	test   %edx,%edx
801048e5:	74 19                	je     80104900 <syscall+0x40>
    curproc->tf->eax = syscalls[num]();
801048e7:	ff d2                	call   *%edx
801048e9:	89 c2                	mov    %eax,%edx
801048eb:	8b 43 18             	mov    0x18(%ebx),%eax
801048ee:	89 50 1c             	mov    %edx,0x1c(%eax)
  } else {
...
80104900:	50                   	push   %eax
            curproc->pid, curproc->name, num);
80104901:	8d 43 6c             	lea    0x6c(%ebx),%eax
    cprintf("%d %s: unknown sys call %d\n",
80104904:	50                   	push   %eax
80104905:	ff 73 10             	pushl  0x10(%ebx)
80104908:	68 95 75 10 80       	push   $0x80107595
8010490d:	e8 8e bd ff ff       	call   801006a0 <cprintf>
    curproc->tf->eax = -1;
80104912:	8b 43 18             	mov    0x18(%ebx),%eax
80104915:	83 c4 10             	add    $0x10,%esp
80104918:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
}
...
80104935:	8d 7d da             	lea    -0x26(%ebp),%edi
{
...
80104947:	89 4d bc             	mov    %ecx,-0x44(%ebp)
  if((dp = nameiparent(path, name)) == 0)
8010494a:	e8 81 d6 ff ff       	call   80101fd0 <nameiparent>
...
80104960:	e8 ab cd ff ff       	call   80101710 <ilock>

  if((ip = dirlookup(dp, name, &off)) != 0){
80104965:	83 c4 0c             	add    $0xc,%esp
80104968:	8d 45 d4             	lea    -0x2c(%ebp),%eax
8010496b:	50                   	push   %eax
8010496c:	57                   	push   %edi
8010496d:	53                   	push   %ebx
8010496e:	e8 cd d2 ff ff       	call   80101c40 <dirlookup>
...
80104980:	e8 1b d0 ff ff       	call   801019a0 <iunlockput>
    ilock(ip);
80104985:	89 34 24             	mov    %esi,(%esp)
80104988:	e8 83 cd ff ff       	call   80101710 <ilock>
...
801049b3:	56                   	push   %esi
    return 0;
801049b4:	31 f6                	xor    %esi,%esi
    iunlockput(ip);
801049b6:	e8 e5 cf ff ff       	call   801019a0 <iunlockput>
    return 0;
...
801049da:	e8 c1 cb ff ff       	call   801015a0 <ialloc>
801049df:	83 c4 10             	add    $0x10,%esp
801049e2:	89 c6                	mov    %eax,%esi
801049e4:	85 c0                	test   %eax,%eax
801049e6:	0f 84 cd 00 00 00    	je     80104ab9 <create+0x189>
  ilock(ip);
...
801049f9:	66 89 46 52          	mov    %ax,0x52(%esi)
  ip->minor = minor;
801049fd:	0f b7 45 bc          	movzwl -0x44(%ebp),%eax
80104a01:	66 89 46 54          	mov    %ax,0x54(%esi)
  ip->nlink = 1;
80104a05:	b8 01 00 00 00       	mov    $0x1,%eax
80104a0a:	66 89 46 56          	mov    %ax,0x56(%esi)
  iupdate(ip);
80104a0e:	89 34 24             	mov    %esi,(%esp)
80104a11:	e8 4a cc ff ff       	call   80101660 <iupdate>
  if(type == T_DIR){  // Create . and .. entries.
80104a16:	83 c4 10             	add    $0x10,%esp
80104a19:	66 83 7d c4 01       	cmpw   $0x1,-0x3c(%ebp)
80104a1e:	74 30                	je     80104a50 <create+0x120>
  if(dirlink(dp, name, ip->inum) < 0)
80104a20:	83 ec 04             	sub    $0x4,%esp
80104a23:	ff 76 04             	pushl  0x4(%esi)
80104a26:	57                   	push   %edi
80104a27:	53                   	push   %ebx
80104a28:	e8 c3 d4 ff ff       	call   80101ef0 <dirlink>
80104a2d:	83 c4 10             	add    $0x10,%esp
80104a30:	85 c0                	test   %eax,%eax
80104a32:	78 78                	js     80104aac <create+0x17c>
  iunlockput(dp);
80104a34:	83 ec 0c             	sub    $0xc,%esp
80104a37:	53                   	push   %ebx
80104a38:	e8 63 cf ff ff       	call   801019a0 <iunlockput>
  return ip;
80104a3d:	83 c4 10             	add    $0x10,%esp
}
80104a40:	8d 65 f4             	lea    -0xc(%ebp),%esp
80104a43:	89 f0                	mov    %esi,%eax
80104a45:	5b                   	pop    %ebx
80104a46:	5e                   	pop    %esi
80104a47:	5f                   	pop    %edi
80104a48:	5d                   	pop    %ebp
...
80104a50:	83 ec 0c             	sub    $0xc,%esp
    dp->nlink++;  // for ".."
80104a53:	66 83 43 56 01       	addw   $0x1,0x56(%ebx)
    iupdate(dp);
80104a58:	53                   	push   %ebx
80104a59:	e8 02 cc ff ff       	call   80101660 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104a5e:	83 c4 0c             	add    $0xc,%esp
80104a61:	ff 76 04             	pushl  0x4(%esi)
80104a64:	68 34 76 10 80       	push   $0x80107634
80104a69:	56                   	push   %esi
80104a6a:	e8 81 d4 ff ff       	call   80101ef0 <dirlink>
80104a6f:	83 c4 10             	add    $0x10,%esp
80104a72:	85 c0                	test   %eax,%eax
80104a74:	78 18                	js     80104a8e <create+0x15e>
80104a76:	83 ec 04             	sub    $0x4,%esp
80104a79:	ff 73 04             	pushl  0x4(%ebx)
80104a7c:	68 33 76 10 80       	push   $0x80107633
80104a81:	56                   	push   %esi
80104a82:	e8 69 d4 ff ff       	call   80101ef0 <dirlink>
80104a87:	83 c4 10             	add    $0x10,%esp
80104a8a:	85 c0                	test   %eax,%eax
80104a8c:	79 92                	jns    80104a20 <create+0xf0>
      panic("create dots");
80104a8e:	83 ec 0c             	sub    $0xc,%esp
80104a91:	68 27 76 10 80       	push   $0x80107627
80104a96:	e8 e5 b8 ff ff       	call   80100380 <panic>
80104a9b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104a9f:	90                   	nop
}
80104aa0:	8d 65 f4             	lea    -0xc(%ebp),%esp
    return 0;
80104aa3:	31 f6                	xor    %esi,%esi
}
80104aa5:	5b                   	pop    %ebx
80104aa6:	89 f0                	mov    %esi,%eax
80104aa8:	5e                   	pop    %esi
80104aa9:	5f                   	pop    %edi
80104aaa:	5d                   	pop    %ebp
80104aab:	c3                   	ret    
...
80104aaf:	68 36 76 10 80       	push   $0x80107636
80104ab4:	e8 c7 b8 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104ab9:	83 ec 0c             	sub    $0xc,%esp
80104abc:	68 18 76 10 80       	push   $0x80107618
80104ac1:	e8 ba b8 ff ff       	call   80100380 <panic>
...
80104ad4:	89 d6                	mov    %edx,%esi
80104ad6:	53                   	push   %ebx
80104ad7:	89 c3                	mov    %eax,%ebx
  if(argint(n, &fd) < 0)
...
80104ae2:	e8 e9 fc ff ff       	call   801047d0 <argint>
...
80104af4:	e8 77 ed ff ff       	call   80103870 <myproc>
...
80104b39:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104b3b:	e8 30 ed ff ff       	call   80103870 <myproc>
...
80104b50:	8d 65 f8             	lea    -0x8(%ebp),%esp
    return -1;
80104b53:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
}
80104b58:	89 d8                	mov    %ebx,%eax
80104b5a:	5b                   	pop    %ebx
80104b5b:	5e                   	pop    %esi
80104b5c:	5d                   	pop    %ebp
80104b5d:	c3                   	ret    
...
80104b6a:	e8 f1 c2 ff ff       	call   80100e60 <filedup>
  return fd;
...
80104b8b:	e8 40 ff ff ff       	call   80104ad0 <argfd.constprop.0>
...
80104bcd:	e8 0e c4 ff ff       	call   80100fe0 <fileread>
...
80104bfb:	e8 d0 fe ff ff       	call   80104ad0 <argfd.constprop.0>
...
80104c3d:	e8 2e c4 ff ff       	call   80101070 <filewrite>
...
80104c6c:	e8 5f fe ff ff       	call   80104ad0 <argfd.constprop.0>
80104c71:	85 c0                	test   %eax,%eax
80104c73:	78 2b                	js     80104ca0 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104c75:	e8 f6 eb ff ff       	call   80103870 <myproc>
...
80104c8b:	e8 20 c2 ff ff       	call   80100eb0 <fileclose>
  return 0;
...
80104cbb:	e8 10 fe ff ff       	call   80104ad0 <argfd.constprop.0>
...
80104ce4:	e8 a7 c2 ff ff       	call   80100f90 <filestat>
...
80104d05:	8d 45 d4             	lea    -0x2c(%ebp),%eax
{
...
80104d22:	8d 45 d0             	lea    -0x30(%ebp),%eax
...
80104d32:	0f 88 e2 00 00 00    	js     80104e1a <sys_link+0x11a>
  begin_op();
80104d38:	e8 33 df ff ff       	call   80102c70 <begin_op>
  if((ip = namei(old)) == 0){
80104d3d:	83 ec 0c             	sub    $0xc,%esp
80104d40:	ff 75 d4             	pushl  -0x2c(%ebp)
80104d43:	e8 68 d2 ff ff       	call   80101fb0 <namei>
80104d48:	83 c4 10             	add    $0x10,%esp
80104d4b:	89 c3                	mov    %eax,%ebx
80104d4d:	85 c0                	test   %eax,%eax
80104d4f:	0f 84 e4 00 00 00    	je     80104e39 <sys_link+0x139>
  ilock(ip);
80104d55:	83 ec 0c             	sub    $0xc,%esp
80104d58:	50                   	push   %eax
80104d59:	e8 b2 c9 ff ff       	call   80101710 <ilock>
  if(ip->type == T_DIR){
80104d5e:	83 c4 10             	add    $0x10,%esp
80104d61:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80104d66:	0f 84 b5 00 00 00    	je     80104e21 <sys_link+0x121>
  iupdate(ip);
80104d6c:	83 ec 0c             	sub    $0xc,%esp
  ip->nlink++;
80104d6f:	66 83 43 56 01       	addw   $0x1,0x56(%ebx)
  if((dp = nameiparent(new, name)) == 0)
80104d74:	8d 7d da             	lea    -0x26(%ebp),%edi
  iupdate(ip);
80104d77:	53                   	push   %ebx
80104d78:	e8 e3 c8 ff ff       	call   80101660 <iupdate>
  iunlock(ip);
80104d7d:	89 1c 24             	mov    %ebx,(%esp)
80104d80:	e8 6b ca ff ff       	call   801017f0 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80104d85:	58                   	pop    %eax
80104d86:	5a                   	pop    %edx
80104d87:	57                   	push   %edi
80104d88:	ff 75 d0             	pushl  -0x30(%ebp)
80104d8b:	e8 40 d2 ff ff       	call   80101fd0 <nameiparent>
...
80104d9d:	e8 6e c9 ff ff       	call   80101710 <ilock>
...
80104db3:	e8 38 d1 ff ff       	call   80101ef0 <dirlink>
...
80104dc3:	e8 d8 cb ff ff       	call   801019a0 <iunlockput>
  iput(ip);
80104dc8:	89 1c 24             	mov    %ebx,(%esp)
80104dcb:	e8 70 ca ff ff       	call   80101840 <iput>
  end_op();
80104dd0:	e8 0b df ff ff       	call   80102ce0 <end_op>
  return 0;
...
80104dec:	e8 af cb ff ff       	call   801019a0 <iunlockput>
    goto bad;
80104df1:	83 c4 10             	add    $0x10,%esp
  ilock(ip);
80104df4:	83 ec 0c             	sub    $0xc,%esp
80104df7:	53                   	push   %ebx
80104df8:	e8 13 c9 ff ff       	call   80101710 <ilock>
  ip->nlink--;
80104dfd:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80104e02:	89 1c 24             	mov    %ebx,(%esp)
80104e05:	e8 56 c8 ff ff       	call   80101660 <iupdate>
  iunlockput(ip);
80104e0a:	89 1c 24             	mov    %ebx,(%esp)
80104e0d:	e8 8e cb ff ff       	call   801019a0 <iunlockput>
  end_op();
80104e12:	e8 c9 de ff ff       	call   80102ce0 <end_op>
  return -1;
80104e17:	83 c4 10             	add    $0x10,%esp
80104e1a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104e1f:	eb b9                	jmp    80104dda <sys_link+0xda>
    iunlockput(ip);
80104e21:	83 ec 0c             	sub    $0xc,%esp
80104e24:	53                   	push   %ebx
80104e25:	e8 76 cb ff ff       	call   801019a0 <iunlockput>
    end_op();
80104e2a:	e8 b1 de ff ff       	call   80102ce0 <end_op>
    return -1;
80104e2f:	83 c4 10             	add    $0x10,%esp
80104e32:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104e37:	eb a1                	jmp    80104dda <sys_link+0xda>
    end_op();
80104e39:	e8 a2 de ff ff       	call   80102ce0 <end_op>
    return -1;
80104e3e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104e43:	eb 95                	jmp    80104dda <sys_link+0xda>
80104e45:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
80104e54:	56                   	push   %esi
  if(argstr(0, &path) < 0)
80104e55:	8d 45 c0             	lea    -0x40(%ebp),%eax
{
...
80104e69:	0f 88 91 01 00 00    	js     80105000 <sys_unlink+0x1b0>
  begin_op();
80104e6f:	e8 fc dd ff ff       	call   80102c70 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80104e74:	8d 5d ca             	lea    -0x36(%ebp),%ebx
80104e77:	83 ec 08             	sub    $0x8,%esp
80104e7a:	53                   	push   %ebx
80104e7b:	ff 75 c0             	pushl  -0x40(%ebp)
80104e7e:	e8 4d d1 ff ff       	call   80101fd0 <nameiparent>
80104e83:	83 c4 10             	add    $0x10,%esp
80104e86:	89 c6                	mov    %eax,%esi
80104e88:	85 c0                	test   %eax,%eax
80104e8a:	0f 84 7a 01 00 00    	je     8010500a <sys_unlink+0x1ba>
  ilock(dp);
80104e90:	83 ec 0c             	sub    $0xc,%esp
80104e93:	50                   	push   %eax
80104e94:	e8 77 c8 ff ff       	call   80101710 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80104e99:	58                   	pop    %eax
80104e9a:	5a                   	pop    %edx
80104e9b:	68 34 76 10 80       	push   $0x80107634
80104ea0:	53                   	push   %ebx
80104ea1:	e8 7a cd ff ff       	call   80101c20 <namecmp>
80104ea6:	83 c4 10             	add    $0x10,%esp
80104ea9:	85 c0                	test   %eax,%eax
80104eab:	0f 84 0f 01 00 00    	je     80104fc0 <sys_unlink+0x170>
80104eb1:	83 ec 08             	sub    $0x8,%esp
80104eb4:	68 33 76 10 80       	push   $0x80107633
80104eb9:	53                   	push   %ebx
80104eba:	e8 61 cd ff ff       	call   80101c20 <namecmp>
80104ebf:	83 c4 10             	add    $0x10,%esp
80104ec2:	85 c0                	test   %eax,%eax
80104ec4:	0f 84 f6 00 00 00    	je     80104fc0 <sys_unlink+0x170>
  if((ip = dirlookup(dp, name, &off)) == 0)
80104eca:	83 ec 04             	sub    $0x4,%esp
80104ecd:	8d 45 c4             	lea    -0x3c(%ebp),%eax
80104ed0:	50                   	push   %eax
80104ed1:	53                   	push   %ebx
80104ed2:	56                   	push   %esi
80104ed3:	e8 68 cd ff ff       	call   80101c40 <dirlookup>
80104ed8:	83 c4 10             	add    $0x10,%esp
80104edb:	89 c3                	mov    %eax,%ebx
80104edd:	85 c0                	test   %eax,%eax
80104edf:	0f 84 db 00 00 00    	je     80104fc0 <sys_unlink+0x170>
  ilock(ip);
...
80104ef6:	0f 8e 37 01 00 00    	jle    80105033 <sys_unlink+0x1e3>
  if(ip->type == T_DIR && !isdirempty(ip)){
80104efc:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80104f01:	8d 7d d8             	lea    -0x28(%ebp),%edi
80104f04:	74 6a                	je     80104f70 <sys_unlink+0x120>
  memset(&de, 0, sizeof(de));
80104f06:	83 ec 04             	sub    $0x4,%esp
80104f09:	6a 10                	push   $0x10
80104f0b:	6a 00                	push   $0x0
80104f0d:	57                   	push   %edi
80104f0e:	e8 fd f5 ff ff       	call   80104510 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80104f13:	6a 10                	push   $0x10
80104f15:	ff 75 c4             	pushl  -0x3c(%ebp)
80104f18:	57                   	push   %edi
80104f19:	56                   	push   %esi
80104f1a:	e8 d1 cb ff ff       	call   80101af0 <writei>
80104f1f:	83 c4 20             	add    $0x20,%esp
80104f22:	83 f8 10             	cmp    $0x10,%eax
80104f25:	0f 85 fb 00 00 00    	jne    80105026 <sys_unlink+0x1d6>
  if(ip->type == T_DIR){
80104f2b:	66 83 7b 50 01       	cmpw   $0x1,0x50(%ebx)
80104f30:	0f 84 aa 00 00 00    	je     80104fe0 <sys_unlink+0x190>
  iunlockput(dp);
80104f36:	83 ec 0c             	sub    $0xc,%esp
80104f39:	56                   	push   %esi
80104f3a:	e8 61 ca ff ff       	call   801019a0 <iunlockput>
  ip->nlink--;
80104f3f:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80104f44:	89 1c 24             	mov    %ebx,(%esp)
80104f47:	e8 14 c7 ff ff       	call   80101660 <iupdate>
  iunlockput(ip);
80104f4c:	89 1c 24             	mov    %ebx,(%esp)
80104f4f:	e8 4c ca ff ff       	call   801019a0 <iunlockput>
  end_op();
80104f54:	e8 87 dd ff ff       	call   80102ce0 <end_op>
  return 0;
...
80104f74:	76 90                	jbe    80104f06 <sys_unlink+0xb6>
80104f76:	ba 20 00 00 00       	mov    $0x20,%edx
80104f7b:	eb 0f                	jmp    80104f8c <sys_unlink+0x13c>
80104f7d:	8d 76 00             	lea    0x0(%esi),%esi
80104f80:	83 c2 10             	add    $0x10,%edx
80104f83:	39 53 58             	cmp    %edx,0x58(%ebx)
80104f86:	0f 86 7a ff ff ff    	jbe    80104f06 <sys_unlink+0xb6>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80104f8c:	6a 10                	push   $0x10
80104f8e:	52                   	push   %edx
80104f8f:	57                   	push   %edi
80104f90:	53                   	push   %ebx
80104f91:	89 55 b4             	mov    %edx,-0x4c(%ebp)
80104f94:	e8 57 ca ff ff       	call   801019f0 <readi>
80104f99:	83 c4 10             	add    $0x10,%esp
80104f9c:	8b 55 b4             	mov    -0x4c(%ebp),%edx
80104f9f:	83 f8 10             	cmp    $0x10,%eax
80104fa2:	75 75                	jne    80105019 <sys_unlink+0x1c9>
    if(de.inum != 0)
80104fa4:	66 83 7d d8 00       	cmpw   $0x0,-0x28(%ebp)
80104fa9:	74 d5                	je     80104f80 <sys_unlink+0x130>
    iunlockput(ip);
...
80105005:	e9 54 ff ff ff       	jmp    80104f5e <sys_unlink+0x10e>
    end_op();
8010500a:	e8 d1 dc ff ff       	call   80102ce0 <end_op>
    return -1;
8010500f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105014:	e9 45 ff ff ff       	jmp    80104f5e <sys_unlink+0x10e>
      panic("isdirempty: readi");
80105019:	83 ec 0c             	sub    $0xc,%esp
8010501c:	68 58 76 10 80       	push   $0x80107658
80105021:	e8 5a b3 ff ff       	call   80100380 <panic>
    panic("unlink: writei");
80105026:	83 ec 0c             	sub    $0xc,%esp
80105029:	68 6a 76 10 80       	push   $0x8010766a
8010502e:	e8 4d b3 ff ff       	call   80100380 <panic>
    panic("unlink: nlink < 1");
80105033:	83 ec 0c             	sub    $0xc,%esp
80105036:	68 46 76 10 80       	push   $0x80107646
8010503b:	e8 40 b3 ff ff       	call   80100380 <panic>
...
80105045:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
...
8010504f:	e8 2c f8 ff ff       	call   80104880 <argstr>
80105054:	83 c4 10             	add    $0x10,%esp
80105057:	85 c0                	test   %eax,%eax
80105059:	0f 88 8e 00 00 00    	js     801050ed <sys_open+0xad>
8010505f:	83 ec 08             	sub    $0x8,%esp
80105062:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105065:	50                   	push   %eax
80105066:	6a 01                	push   $0x1
80105068:	e8 63 f7 ff ff       	call   801047d0 <argint>
8010506d:	83 c4 10             	add    $0x10,%esp
80105070:	85 c0                	test   %eax,%eax
80105072:	78 79                	js     801050ed <sys_open+0xad>
    return -1;

  begin_op();
80105074:	e8 f7 db ff ff       	call   80102c70 <begin_op>

  if(omode & O_CREATE){
80105079:	f6 45 e5 02          	testb  $0x2,-0x1b(%ebp)
8010507d:	75 79                	jne    801050f8 <sys_open+0xb8>
    if(ip == 0){
      end_op();
      return -1;
    }
...
80105085:	e8 26 cf ff ff       	call   80101fb0 <namei>
8010508a:	83 c4 10             	add    $0x10,%esp
8010508d:	89 c6                	mov    %eax,%esi
8010508f:	85 c0                	test   %eax,%eax
80105091:	0f 84 7e 00 00 00    	je     80105115 <sys_open+0xd5>
      end_op();
      return -1;
    }
    ilock(ip);
...
8010509b:	e8 70 c6 ff ff       	call   80101710 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
801050a0:	83 c4 10             	add    $0x10,%esp
801050a3:	66 83 7e 50 01       	cmpw   $0x1,0x50(%esi)
801050a8:	0f 84 c2 00 00 00    	je     80105170 <sys_open+0x130>
      end_op();
      return -1;
    }
  }
...
801050ae:	e8 3d bd ff ff       	call   80100df0 <filealloc>
801050b3:	89 c7                	mov    %eax,%edi
801050b5:	85 c0                	test   %eax,%eax
801050b7:	74 23                	je     801050dc <sys_open+0x9c>
  struct proc *curproc = myproc();
801050b9:	e8 b2 e7 ff ff       	call   80103870 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
801050be:	31 db                	xor    %ebx,%ebx
    if(curproc->ofile[fd] == 0){
801050c0:	8b 54 98 28          	mov    0x28(%eax,%ebx,4),%edx
801050c4:	85 d2                	test   %edx,%edx
801050c6:	74 60                	je     80105128 <sys_open+0xe8>
  for(fd = 0; fd < NOFILE; fd++){
...
801050d4:	e8 d7 bd ff ff       	call   80100eb0 <fileclose>
801050d9:	83 c4 10             	add    $0x10,%esp
    iunlockput(ip);
801050dc:	83 ec 0c             	sub    $0xc,%esp
801050df:	56                   	push   %esi
801050e0:	e8 bb c8 ff ff       	call   801019a0 <iunlockput>
    end_op();
801050e5:	e8 f6 db ff ff       	call   80102ce0 <end_op>
    return -1;
801050ea:	83 c4 10             	add    $0x10,%esp
801050ed:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
801050f2:	eb 6d                	jmp    80105161 <sys_open+0x121>
801050f4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ip = create(path, T_FILE, 0, 0);
801050f8:	83 ec 0c             	sub    $0xc,%esp
801050fb:	8b 45 e0             	mov    -0x20(%ebp),%eax
801050fe:	31 c9                	xor    %ecx,%ecx
80105100:	ba 02 00 00 00       	mov    $0x2,%edx
80105105:	6a 00                	push   $0x0
80105107:	e8 24 f8 ff ff       	call   80104930 <create>
    if(ip == 0){
...
80105113:	75 99                	jne    801050ae <sys_open+0x6e>
      end_op();
80105115:	e8 c6 db ff ff       	call   80102ce0 <end_op>
      return -1;
8010511a:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
8010511f:	eb 40                	jmp    80105161 <sys_open+0x121>
80105121:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  }
  iunlock(ip);
80105128:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
8010512b:	89 7c 98 28          	mov    %edi,0x28(%eax,%ebx,4)
  iunlock(ip);
8010512f:	56                   	push   %esi
80105130:	e8 bb c6 ff ff       	call   801017f0 <iunlock>
  end_op();
80105135:	e8 a6 db ff ff       	call   80102ce0 <end_op>

  f->type = FD_INODE;
8010513a:	c7 07 02 00 00 00    	movl   $0x2,(%edi)
  f->ip = ip;
  f->off = 0;
  f->readable = !(omode & O_WRONLY);
80105140:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80105143:	83 c4 10             	add    $0x10,%esp
  f->ip = ip;
80105146:	89 77 10             	mov    %esi,0x10(%edi)
  f->readable = !(omode & O_WRONLY);
80105149:	89 d0                	mov    %edx,%eax
  f->off = 0;
8010514b:	c7 47 14 00 00 00 00 	movl   $0x0,0x14(%edi)
  f->readable = !(omode & O_WRONLY);
80105152:	f7 d0                	not    %eax
80105154:	83 e0 01             	and    $0x1,%eax
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80105157:	83 e2 03             	and    $0x3,%edx
  f->readable = !(omode & O_WRONLY);
8010515a:	88 47 08             	mov    %al,0x8(%edi)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
8010515d:	0f 95 47 09          	setne  0x9(%edi)
  return fd;
}
80105161:	8d 65 f4             	lea    -0xc(%ebp),%esp
80105164:	89 d8                	mov    %ebx,%eax
80105166:	5b                   	pop    %ebx
80105167:	5e                   	pop    %esi
80105168:	5f                   	pop    %edi
80105169:	5d                   	pop    %ebp
...
80105175:	0f 84 33 ff ff ff    	je     801050ae <sys_open+0x6e>
8010517b:	e9 5c ff ff ff       	jmp    801050dc <sys_open+0x9c>
...
80105183:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
80105186:	e8 e5 da ff ff       	call   80102c70 <begin_op>
  if(argstr(0, &path) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
8010518b:	83 ec 08             	sub    $0x8,%esp
8010518e:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105191:	50                   	push   %eax
80105192:	6a 00                	push   $0x0
80105194:	e8 e7 f6 ff ff       	call   80104880 <argstr>
...
801051a8:	ba 01 00 00 00       	mov    $0x1,%edx
801051ad:	6a 00                	push   $0x0
801051af:	e8 7c f7 ff ff       	call   80104930 <create>
...
801051bf:	e8 dc c7 ff ff       	call   801019a0 <iunlockput>
  end_op();
801051c4:	e8 17 db ff ff       	call   80102ce0 <end_op>
  return 0;
...
801051cf:	c3                   	ret    
    end_op();
801051d0:	e8 0b db ff ff       	call   80102ce0 <end_op>
    return -1;
...
801051ee:	8d 45 ec             	lea    -0x14(%ebp),%eax
801051f1:	50                   	push   %eax
801051f2:	6a 00                	push   $0x0
801051f4:	e8 87 f6 ff ff       	call   80104880 <argstr>
...
80105209:	e8 c2 f5 ff ff       	call   801047d0 <argint>
  if((argstr(0, &path)) < 0 ||
...
80105218:	8d 45 f4             	lea    -0xc(%ebp),%eax
8010521b:	50                   	push   %eax
8010521c:	6a 02                	push   $0x2
8010521e:	e8 ad f5 ff ff       	call   801047d0 <argint>
     argint(1, &major) < 0 ||
...
8010523e:	e8 ed f6 ff ff       	call   80104930 <create>
     argint(2, &minor) < 0 ||
...
8010524e:	e8 4d c7 ff ff       	call   801019a0 <iunlockput>
  end_op();
80105253:	e8 88 da ff ff       	call   80102ce0 <end_op>
  return 0;
...
8010525f:	90                   	nop
    end_op();
80105260:	e8 7b da ff ff       	call   80102ce0 <end_op>
    return -1;
...
8010529f:	e8 0c cd ff ff       	call   80101fb0 <namei>
...
801052b1:	e8 5a c4 ff ff       	call   80101710 <ilock>
  if(ip->type != T_DIR){
...
801052c4:	e8 27 c5 ff ff       	call   801017f0 <iunlock>
  iput(curproc->cwd);
801052c9:	58                   	pop    %eax
801052ca:	ff 76 68             	pushl  0x68(%esi)
801052cd:	e8 6e c5 ff ff       	call   80101840 <iput>
  end_op();
801052d2:	e8 09 da ff ff       	call   80102ce0 <end_op>
  curproc->cwd = ip;
...
801052f4:	e8 a7 c6 ff ff       	call   801019a0 <iunlockput>
    end_op();
801052f9:	e8 e2 d9 ff ff       	call   80102ce0 <end_op>
    return -1;
...
80105325:	8d 85 5c ff ff ff    	lea    -0xa4(%ebp),%eax
{
...
80105335:	e8 46 f5 ff ff       	call   80104880 <argstr>
...
80105348:	8d 85 60 ff ff ff    	lea    -0xa0(%ebp),%eax
8010534e:	50                   	push   %eax
8010534f:	6a 01                	push   $0x1
80105351:	e8 7a f4 ff ff       	call   801047d0 <argint>
...
8010536d:	8d bd 64 ff ff ff    	lea    -0x9c(%ebp),%edi
80105373:	6a 00                	push   $0x0
80105375:	50                   	push   %eax
80105376:	e8 95 f1 ff ff       	call   80104510 <memset>
...
80105386:	8d 34 9d 00 00 00 00 	lea    0x0(,%ebx,4),%esi
8010538d:	83 ec 08             	sub    $0x8,%esp
80105390:	57                   	push   %edi
80105391:	01 f0                	add    %esi,%eax
80105393:	50                   	push   %eax
80105394:	e8 a7 f3 ff ff       	call   80104740 <fetchint>
80105399:	83 c4 10             	add    $0x10,%esp
8010539c:	85 c0                	test   %eax,%eax
8010539e:	78 2c                	js     801053cc <sys_exec+0xac>
      return -1;
    if(uarg == 0){
801053a0:	8b 85 64 ff ff ff    	mov    -0x9c(%ebp),%eax
801053a6:	85 c0                	test   %eax,%eax
801053a8:	74 36                	je     801053e0 <sys_exec+0xc0>
      argv[i] = 0;
      break;
    }
...
801053b8:	e8 c3 f3 ff ff       	call   80104780 <fetchstr>
801053bd:	83 c4 10             	add    $0x10,%esp
801053c0:	85 c0                	test   %eax,%eax
801053c2:	78 08                	js     801053cc <sys_exec+0xac>
  for(i=0;; i++){
801053c4:	83 c3 01             	add    $0x1,%ebx
    if(i >= NELEM(argv))
801053c7:	83 fb 20             	cmp    $0x20,%ebx
801053ca:	75 b4                	jne    80105380 <sys_exec+0x60>
      return -1;
  }
...
801053e3:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
      argv[i] = 0;
...
80105415:	8d 45 dc             	lea    -0x24(%ebp),%eax
{
...
80105421:	e8 fa f3 ff ff       	call   80104820 <argptr>
...
80105430:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105433:	50                   	push   %eax
80105434:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105437:	50                   	push   %eax
80105438:	e8 d3 de ff ff       	call   80103310 <pipealloc>
...
80105444:	8b 7d e0             	mov    -0x20(%ebp),%edi
  for(fd = 0; fd < NOFILE; fd++){
80105447:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105449:	e8 22 e4 ff ff       	call   80103870 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105466:	e8 45 ba ff ff       	call   80100eb0 <fileclose>
    fileclose(wf);
8010546b:	58                   	pop    %eax
8010546c:	ff 75 e4             	pushl  -0x1c(%ebp)
8010546f:	e8 3c ba ff ff       	call   80100eb0 <fileclose>
    return -1;
80105474:	83 c4 10             	add    $0x10,%esp
80105477:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010547c:	eb 53                	jmp    801054d1 <sys_pipe+0xc1>
...
80105487:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
8010548a:	e8 e1 e3 ff ff       	call   80103870 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
8010548f:	31 d2                	xor    %edx,%edx
80105491:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(curproc->ofile[fd] == 0){
80105498:	8b 4c 90 28          	mov    0x28(%eax,%edx,4),%ecx
8010549c:	85 c9                	test   %ecx,%ecx
8010549e:	74 20                	je     801054c0 <sys_pipe+0xb0>
  for(fd = 0; fd < NOFILE; fd++){
801054a0:	83 c2 01             	add    $0x1,%edx
801054a3:	83 fa 10             	cmp    $0x10,%edx
801054a6:	75 f0                	jne    80105498 <sys_pipe+0x88>
      myproc()->ofile[fd0] = 0;
801054a8:	e8 c3 e3 ff ff       	call   80103870 <myproc>
801054ad:	c7 44 b0 08 00 00 00 	movl   $0x0,0x8(%eax,%esi,4)
801054b4:	00 
801054b5:	eb a9                	jmp    80105460 <sys_pipe+0x50>
...
{
  return fork();
801054e0:	e9 2b e5 ff ff       	jmp    80103a10 <fork>
...
801054f3:	83 ec 08             	sub    $0x8,%esp
  exit();
801054f6:	e8 95 e7 ff ff       	call   80103c90 <exit>
...
{
  return wait();
80105500:	e9 cb e9 ff ff       	jmp    80103ed0 <wait>
...
8010551c:	e8 af f2 ff ff       	call   801047d0 <argint>
...
8010552e:	e8 ed ea ff ff       	call   80104020 <kill>
...
80105553:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105556:	e8 15 e3 ff ff       	call   80103870 <myproc>
...
80105586:	e8 05 e4 ff ff       	call   80103990 <growproc>
...
801055da:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
801055dd:	8b 1d a0 55 11 80    	mov    0x801155a0,%ebx
  while(ticks - ticks0 < n){
...
801055fd:	e8 0e e8 ff ff       	call   80103e10 <sleep>
  while(ticks - ticks0 < n){
...
80105625:	e8 96 ee ff ff       	call   801044c0 <release>
  }
  release(&tickslock);
  return 0;
}
...
80105648:	e8 73 ee ff ff       	call   801044c0 <release>
  return 0;
...
8010567e:	e8 3d ee ff ff       	call   801044c0 <release>
  return xticks;
}
...
801056c7:	c7 04 c5 a2 4d 11 80 	movl   $0x8e000008,-0x7feeb25e(,%eax,8)
801056ce:	08 00 00 8e 
801056d2:	66 89 14 c5 a0 4d 11 	mov    %dx,-0x7feeb260(,%eax,8)
801056d9:	80 
801056da:	c1 ea 10             	shr    $0x10,%edx
801056dd:	66 89 14 c5 a6 4d 11 	mov    %dx,-0x7feeb25a(,%eax,8)
801056e4:	80 
  for(i = 0; i < 256; i++)
...
801056f7:	c7 05 a2 4f 11 80 08 	movl   $0xef000008,0x80114fa2
801056fe:	00 00 ef 
  initlock(&tickslock, "time");
80105701:	68 79 76 10 80       	push   $0x80107679
80105706:	68 60 4d 11 80       	push   $0x80114d60
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010570b:	66 a3 a0 4f 11 80    	mov    %ax,0x80114fa0
80105711:	c1 e8 10             	shr    $0x10,%eax
80105714:	66 a3 a6 4f 11 80    	mov    %ax,0x80114fa6
  initlock(&tickslock, "time");
8010571a:	e8 81 eb ff ff       	call   801042a0 <initlock>
}
...
80105780:	ff 24 85 20 77 10 80 	jmp    *-0x7fef88e0(,%eax,4)
    lapiceoi();
    break;
...
80105787:	e8 e4 e0 ff ff       	call   80103870 <myproc>
...
801057a7:	e8 a4 e0 ff ff       	call   80103850 <cpuid>
...
801057b8:	e8 b3 e0 ff ff       	call   80103870 <myproc>
801057bd:	89 45 e0             	mov    %eax,-0x20(%ebp)
801057c0:	e8 ab e0 ff ff       	call   80103870 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
801057dc:	68 dc 76 10 80       	push   $0x801076dc
801057e1:	e8 ba ae ff ff       	call   801006a0 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
801057e6:	83 c4 20             	add    $0x20,%esp
801057e9:	e8 82 e0 ff ff       	call   80103870 <myproc>
...
8010581b:	e8 50 e0 ff ff       	call   80103870 <myproc>
80105820:	85 c0                	test   %eax,%eax
80105822:	74 0f                	je     80105833 <trap+0xd3>
80105824:	e8 47 e0 ff ff       	call   80103870 <myproc>
...
8010582d:	0f 84 ed 00 00 00    	je     80105920 <trap+0x1c0>
  ...
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105833:	e8 38 e0 ff ff       	call   80103870 <myproc>
80105838:	85 c0                	test   %eax,%eax
8010583a:	74 1d                	je     80105859 <trap+0xf9>
8010583c:	e8 2f e0 ff ff       	call   80103870 <myproc>
...
801058b5:	e8 66 cf ff ff       	call   80102820 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801058ba:	e8 b1 df ff ff       	call   80103870 <myproc>
...
801058d1:	e8 4a cf ff ff       	call   80102820 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801058d6:	e8 95 df ff ff       	call   80103870 <myproc>
...
801058ef:	e8 5c df ff ff       	call   80103850 <cpuid>
...
80105906:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105909:	e8 62 df ff ff       	call   80103870 <myproc>
...
80105942:	75 3c                	jne    80105980 <trap+0x220>
    myproc()->tf = tf;
80105944:	e8 27 df ff ff       	call   80103870 <myproc>
80105949:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
8010594c:	e8 6f ef ff ff       	call   801048c0 <syscall>
    if(myproc()->killed)
80105951:	e8 1a df ff ff       	call   80103870 <myproc>
...
80105998:	68 a8 76 10 80       	push   $0x801076a8
8010599d:	e8 fe ac ff ff       	call   801006a0 <cprintf>
      panic("trap");
801059a2:	83 c4 14             	add    $0x14,%esp
801059a5:	68 7e 76 10 80       	push   $0x8010767e
...
80105a9f:	be 76 00 00 00       	mov    $0x76,%esi
  for(p="xv6...\n"; *p; p++)
80105aa4:	bb a0 77 10 80       	mov    $0x801077a0,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80105b37:	6a 00                	push   $0x0
  jmp alltraps
80105b39:	e9 4c fb ff ff       	jmp    8010568a <alltraps>
...
80105b40:	6a 01                	push   $0x1
  jmp alltraps
80105b42:	e9 43 fb ff ff       	jmp    8010568a <alltraps>
...
80105b49:	6a 02                	push   $0x2
  jmp alltraps
80105b4b:	e9 3a fb ff ff       	jmp    8010568a <alltraps>
...
80105b52:	6a 03                	push   $0x3
  jmp alltraps
80105b54:	e9 31 fb ff ff       	jmp    8010568a <alltraps>
...
80105b5b:	6a 04                	push   $0x4
  jmp alltraps
80105b5d:	e9 28 fb ff ff       	jmp    8010568a <alltraps>
...
80105b64:	6a 05                	push   $0x5
  jmp alltraps
80105b66:	e9 1f fb ff ff       	jmp    8010568a <alltraps>
...
80105b6d:	6a 06                	push   $0x6
  jmp alltraps
80105b6f:	e9 16 fb ff ff       	jmp    8010568a <alltraps>
...
80105b76:	6a 07                	push   $0x7
  jmp alltraps
80105b78:	e9 0d fb ff ff       	jmp    8010568a <alltraps>
...
80105b7d:	6a 08                	push   $0x8
  jmp alltraps
80105b7f:	e9 06 fb ff ff       	jmp    8010568a <alltraps>
...
80105b86:	6a 09                	push   $0x9
  jmp alltraps
80105b88:	e9 fd fa ff ff       	jmp    8010568a <alltraps>
...
80105b8d:	6a 0a                	push   $0xa
  jmp alltraps
80105b8f:	e9 f6 fa ff ff       	jmp    8010568a <alltraps>
...
80105b9b:	6a 0c                	push   $0xc
  jmp alltraps
80105b9d:	e9 e8 fa ff ff       	jmp    8010568a <alltraps>
...
80105ba2:	6a 0d                	push   $0xd
  jmp alltraps
80105ba4:	e9 e1 fa ff ff       	jmp    8010568a <alltraps>
...
80105ba9:	6a 0e                	push   $0xe
  jmp alltraps
80105bab:	e9 da fa ff ff       	jmp    8010568a <alltraps>
...
80105bb2:	6a 0f                	push   $0xf
  jmp alltraps
80105bb4:	e9 d1 fa ff ff       	jmp    8010568a <alltraps>
...
80105bbb:	6a 10                	push   $0x10
  jmp alltraps
80105bbd:	e9 c8 fa ff ff       	jmp    8010568a <alltraps>
...
80105bef:	6a 16                	push   $0x16
  jmp alltraps
80105bf1:	e9 94 fa ff ff       	jmp    8010568a <alltraps>
...
80105bf8:	6a 17                	push   $0x17
  jmp alltraps
80105bfa:	e9 8b fa ff ff       	jmp    8010568a <alltraps>
...
80105c01:	6a 18                	push   $0x18
  jmp alltraps
80105c03:	e9 82 fa ff ff       	jmp    8010568a <alltraps>
...
80105c0a:	6a 19                	push   $0x19
  jmp alltraps
80105c0c:	e9 79 fa ff ff       	jmp    8010568a <alltraps>
...
80105c13:	6a 1a                	push   $0x1a
  jmp alltraps
80105c15:	e9 70 fa ff ff       	jmp    8010568a <alltraps>
...
80105c1c:	6a 1b                	push   $0x1b
  jmp alltraps
80105c1e:	e9 67 fa ff ff       	jmp    8010568a <alltraps>
...
80105c25:	6a 1c                	push   $0x1c
  jmp alltraps
80105c27:	e9 5e fa ff ff       	jmp    8010568a <alltraps>
...
80105c2e:	6a 1d                	push   $0x1d
  jmp alltraps
80105c30:	e9 55 fa ff ff       	jmp    8010568a <alltraps>
...
80105c37:	6a 1e                	push   $0x1e
  jmp alltraps
80105c39:	e9 4c fa ff ff       	jmp    8010568a <alltraps>
...
80105c40:	6a 1f                	push   $0x1f
  jmp alltraps
80105c42:	e9 43 fa ff ff       	jmp    8010568a <alltraps>
...
80105c49:	6a 20                	push   $0x20
  jmp alltraps
80105c4b:	e9 3a fa ff ff       	jmp    8010568a <alltraps>
...
80105c52:	6a 21                	push   $0x21
  jmp alltraps
80105c54:	e9 31 fa ff ff       	jmp    8010568a <alltraps>
...
80105c5b:	6a 22                	push   $0x22
  jmp alltraps
80105c5d:	e9 28 fa ff ff       	jmp    8010568a <alltraps>
...
80105c64:	6a 23                	push   $0x23
  jmp alltraps
80105c66:	e9 1f fa ff ff       	jmp    8010568a <alltraps>
...
80105c6d:	6a 24                	push   $0x24
  jmp alltraps
80105c6f:	e9 16 fa ff ff       	jmp    8010568a <alltraps>
...
80105c76:	6a 25                	push   $0x25
  jmp alltraps
80105c78:	e9 0d fa ff ff       	jmp    8010568a <alltraps>
...
80105c7f:	6a 26                	push   $0x26
  jmp alltraps
80105c81:	e9 04 fa ff ff       	jmp    8010568a <alltraps>
...
80105c88:	6a 27                	push   $0x27
  jmp alltraps
80105c8a:	e9 fb f9 ff ff       	jmp    8010568a <alltraps>
...
80105c91:	6a 28                	push   $0x28
  jmp alltraps
80105c93:	e9 f2 f9 ff ff       	jmp    8010568a <alltraps>
...
80105c9a:	6a 29                	push   $0x29
  jmp alltraps
80105c9c:	e9 e9 f9 ff ff       	jmp    8010568a <alltraps>
...
80105ca3:	6a 2a                	push   $0x2a
  jmp alltraps
80105ca5:	e9 e0 f9 ff ff       	jmp    8010568a <alltraps>
...
80105cac:	6a 2b                	push   $0x2b
  jmp alltraps
80105cae:	e9 d7 f9 ff ff       	jmp    8010568a <alltraps>
...
80105cb5:	6a 2c                	push   $0x2c
  jmp alltraps
80105cb7:	e9 ce f9 ff ff       	jmp    8010568a <alltraps>
...
80105cbe:	6a 2d                	push   $0x2d
  jmp alltraps
80105cc0:	e9 c5 f9 ff ff       	jmp    8010568a <alltraps>
...
80105cc7:	6a 2e                	push   $0x2e
  jmp alltraps
80105cc9:	e9 bc f9 ff ff       	jmp    8010568a <alltraps>
...
80105cd0:	6a 2f                	push   $0x2f
  jmp alltraps
80105cd2:	e9 b3 f9 ff ff       	jmp    8010568a <alltraps>
...
80105cd9:	6a 30                	push   $0x30
  jmp alltraps
80105cdb:	e9 aa f9 ff ff       	jmp    8010568a <alltraps>
...
80105ce2:	6a 31                	push   $0x31
  jmp alltraps
80105ce4:	e9 a1 f9 ff ff       	jmp    8010568a <alltraps>
...
80105ceb:	6a 32                	push   $0x32
  jmp alltraps
80105ced:	e9 98 f9 ff ff       	jmp    8010568a <alltraps>
...
80105cf4:	6a 33                	push   $0x33
  jmp alltraps
80105cf6:	e9 8f f9 ff ff       	jmp    8010568a <alltraps>
...
80105cfd:	6a 34                	push   $0x34
  jmp alltraps
80105cff:	e9 86 f9 ff ff       	jmp    8010568a <alltraps>
...
80105d06:	6a 35                	push   $0x35
  jmp alltraps
80105d08:	e9 7d f9 ff ff       	jmp    8010568a <alltraps>
...
80105d0f:	6a 36                	push   $0x36
  jmp alltraps
80105d11:	e9 74 f9 ff ff       	jmp    8010568a <alltraps>
...
80105d18:	6a 37                	push   $0x37
  jmp alltraps
80105d1a:	e9 6b f9 ff ff       	jmp    8010568a <alltraps>
...
80105d21:	6a 38                	push   $0x38
  jmp alltraps
80105d23:	e9 62 f9 ff ff       	jmp    8010568a <alltraps>
...
80105d2a:	6a 39                	push   $0x39
  jmp alltraps
80105d2c:	e9 59 f9 ff ff       	jmp    8010568a <alltraps>
...
80105d33:	6a 3a                	push   $0x3a
  jmp alltraps
80105d35:	e9 50 f9 ff ff       	jmp    8010568a <alltraps>
...
80105d3c:	6a 3b                	push   $0x3b
  jmp alltraps
80105d3e:	e9 47 f9 ff ff       	jmp    8010568a <alltraps>
...
80105d45:	6a 3c                	push   $0x3c
  jmp alltraps
80105d47:	e9 3e f9 ff ff       	jmp    8010568a <alltraps>
...
80105d4e:	6a 3d                	push   $0x3d
  jmp alltraps
80105d50:	e9 35 f9 ff ff       	jmp    8010568a <alltraps>
...
80105d57:	6a 3e                	push   $0x3e
  jmp alltraps
80105d59:	e9 2c f9 ff ff       	jmp    8010568a <alltraps>
...
80105d60:	6a 3f                	push   $0x3f
  jmp alltraps
80105d62:	e9 23 f9 ff ff       	jmp    8010568a <alltraps>
...
80105d69:	6a 40                	push   $0x40
  jmp alltraps
80105d6b:	e9 1a f9 ff ff       	jmp    8010568a <alltraps>
...
80105d72:	6a 41                	push   $0x41
  jmp alltraps
80105d74:	e9 11 f9 ff ff       	jmp    8010568a <alltraps>
...
80105d7b:	6a 42                	push   $0x42
  jmp alltraps
80105d7d:	e9 08 f9 ff ff       	jmp    8010568a <alltraps>
...
80105d84:	6a 43                	push   $0x43
  jmp alltraps
80105d86:	e9 ff f8 ff ff       	jmp    8010568a <alltraps>
...
80105d8d:	6a 44                	push   $0x44
  jmp alltraps
80105d8f:	e9 f6 f8 ff ff       	jmp    8010568a <alltraps>
...
80105d96:	6a 45                	push   $0x45
  jmp alltraps
80105d98:	e9 ed f8 ff ff       	jmp    8010568a <alltraps>
...
80105d9f:	6a 46                	push   $0x46
  jmp alltraps
80105da1:	e9 e4 f8 ff ff       	jmp    8010568a <alltraps>
...
80105da8:	6a 47                	push   $0x47
  jmp alltraps
80105daa:	e9 db f8 ff ff       	jmp    8010568a <alltraps>
...
80105db1:	6a 48                	push   $0x48
  jmp alltraps
80105db3:	e9 d2 f8 ff ff       	jmp    8010568a <alltraps>
...
80105dba:	6a 49                	push   $0x49
  jmp alltraps
80105dbc:	e9 c9 f8 ff ff       	jmp    8010568a <alltraps>
...
80105dc3:	6a 4a                	push   $0x4a
  jmp alltraps
80105dc5:	e9 c0 f8 ff ff       	jmp    8010568a <alltraps>
...
80105dcc:	6a 4b                	push   $0x4b
  jmp alltraps
80105dce:	e9 b7 f8 ff ff       	jmp    8010568a <alltraps>
...
80105dd5:	6a 4c                	push   $0x4c
  jmp alltraps
80105dd7:	e9 ae f8 ff ff       	jmp    8010568a <alltraps>
...
80105dde:	6a 4d                	push   $0x4d
  jmp alltraps
80105de0:	e9 a5 f8 ff ff       	jmp    8010568a <alltraps>
...
80105de7:	6a 4e                	push   $0x4e
  jmp alltraps
80105de9:	e9 9c f8 ff ff       	jmp    8010568a <alltraps>
...
80105df0:	6a 4f                	push   $0x4f
  jmp alltraps
80105df2:	e9 93 f8 ff ff       	jmp    8010568a <alltraps>
...
80105df9:	6a 50                	push   $0x50
  jmp alltraps
80105dfb:	e9 8a f8 ff ff       	jmp    8010568a <alltraps>
...
80105e02:	6a 51                	push   $0x51
  jmp alltraps
80105e04:	e9 81 f8 ff ff       	jmp    8010568a <alltraps>
...
80105e0b:	6a 52                	push   $0x52
  jmp alltraps
80105e0d:	e9 78 f8 ff ff       	jmp    8010568a <alltraps>
...
80105e14:	6a 53                	push   $0x53
  jmp alltraps
80105e16:	e9 6f f8 ff ff       	jmp    8010568a <alltraps>
...
80105e1d:	6a 54                	push   $0x54
  jmp alltraps
80105e1f:	e9 66 f8 ff ff       	jmp    8010568a <alltraps>
...
80105e26:	6a 55                	push   $0x55
  jmp alltraps
80105e28:	e9 5d f8 ff ff       	jmp    8010568a <alltraps>
...
80105e2f:	6a 56                	push   $0x56
  jmp alltraps
80105e31:	e9 54 f8 ff ff       	jmp    8010568a <alltraps>
...
80105e38:	6a 57                	push   $0x57
  jmp alltraps
80105e3a:	e9 4b f8 ff ff       	jmp    8010568a <alltraps>
...
80105e41:	6a 58                	push   $0x58
  jmp alltraps
80105e43:	e9 42 f8 ff ff       	jmp    8010568a <alltraps>
...
80105e4a:	6a 59                	push   $0x59
  jmp alltraps
80105e4c:	e9 39 f8 ff ff       	jmp    8010568a <alltraps>
...
80105e53:	6a 5a                	push   $0x5a
  jmp alltraps
80105e55:	e9 30 f8 ff ff       	jmp    8010568a <alltraps>
...
80105e5c:	6a 5b                	push   $0x5b
  jmp alltraps
80105e5e:	e9 27 f8 ff ff       	jmp    8010568a <alltraps>
...
80105e65:	6a 5c                	push   $0x5c
  jmp alltraps
80105e67:	e9 1e f8 ff ff       	jmp    8010568a <alltraps>
...
80105e6e:	6a 5d                	push   $0x5d
  jmp alltraps
80105e70:	e9 15 f8 ff ff       	jmp    8010568a <alltraps>
...
80105e77:	6a 5e                	push   $0x5e
  jmp alltraps
80105e79:	e9 0c f8 ff ff       	jmp    8010568a <alltraps>
...
80105e80:	6a 5f                	push   $0x5f
  jmp alltraps
80105e82:	e9 03 f8 ff ff       	jmp    8010568a <alltraps>
...
80105e89:	6a 60                	push   $0x60
  jmp alltraps
80105e8b:	e9 fa f7 ff ff       	jmp    8010568a <alltraps>
...
80105e92:	6a 61                	push   $0x61
  jmp alltraps
80105e94:	e9 f1 f7 ff ff       	jmp    8010568a <alltraps>
...
80105e9b:	6a 62                	push   $0x62
  jmp alltraps
80105e9d:	e9 e8 f7 ff ff       	jmp    8010568a <alltraps>
...
80105ea4:	6a 63                	push   $0x63
  jmp alltraps
80105ea6:	e9 df f7 ff ff       	jmp    8010568a <alltraps>
...
80105ead:	6a 64                	push   $0x64
  jmp alltraps
80105eaf:	e9 d6 f7 ff ff       	jmp    8010568a <alltraps>
...
80105eb6:	6a 65                	push   $0x65
  jmp alltraps
80105eb8:	e9 cd f7 ff ff       	jmp    8010568a <alltraps>
...
80105ebf:	6a 66                	push   $0x66
  jmp alltraps
80105ec1:	e9 c4 f7 ff ff       	jmp    8010568a <alltraps>
...
80105ec8:	6a 67                	push   $0x67
  jmp alltraps
80105eca:	e9 bb f7 ff ff       	jmp    8010568a <alltraps>
...
80105ed1:	6a 68                	push   $0x68
  jmp alltraps
80105ed3:	e9 b2 f7 ff ff       	jmp    8010568a <alltraps>
...
80105eda:	6a 69                	push   $0x69
  jmp alltraps
80105edc:	e9 a9 f7 ff ff       	jmp    8010568a <alltraps>
...
80105ee3:	6a 6a                	push   $0x6a
  jmp alltraps
80105ee5:	e9 a0 f7 ff ff       	jmp    8010568a <alltraps>
...
80105eec:	6a 6b                	push   $0x6b
  jmp alltraps
80105eee:	e9 97 f7 ff ff       	jmp    8010568a <alltraps>
...
80105ef5:	6a 6c                	push   $0x6c
  jmp alltraps
80105ef7:	e9 8e f7 ff ff       	jmp    8010568a <alltraps>
...
80105efe:	6a 6d                	push   $0x6d
  jmp alltraps
80105f00:	e9 85 f7 ff ff       	jmp    8010568a <alltraps>
...
80105f07:	6a 6e                	push   $0x6e
  jmp alltraps
80105f09:	e9 7c f7 ff ff       	jmp    8010568a <alltraps>
...
80105f10:	6a 6f                	push   $0x6f
  jmp alltraps
80105f12:	e9 73 f7 ff ff       	jmp    8010568a <alltraps>
...
80105f19:	6a 70                	push   $0x70
  jmp alltraps
80105f1b:	e9 6a f7 ff ff       	jmp    8010568a <alltraps>
...
80105f22:	6a 71                	push   $0x71
  jmp alltraps
80105f24:	e9 61 f7 ff ff       	jmp    8010568a <alltraps>
...
80105f2b:	6a 72                	push   $0x72
  jmp alltraps
80105f2d:	e9 58 f7 ff ff       	jmp    8010568a <alltraps>
...
80105f34:	6a 73                	push   $0x73
  jmp alltraps
80105f36:	e9 4f f7 ff ff       	jmp    8010568a <alltraps>
...
80105f3d:	6a 74                	push   $0x74
  jmp alltraps
80105f3f:	e9 46 f7 ff ff       	jmp    8010568a <alltraps>
...
80105f46:	6a 75                	push   $0x75
  jmp alltraps
80105f48:	e9 3d f7 ff ff       	jmp    8010568a <alltraps>
...
80105f4f:	6a 76                	push   $0x76
  jmp alltraps
80105f51:	e9 34 f7 ff ff       	jmp    8010568a <alltraps>
...
80105f58:	6a 77                	push   $0x77
  jmp alltraps
80105f5a:	e9 2b f7 ff ff       	jmp    8010568a <alltraps>
...
80105f61:	6a 78                	push   $0x78
  jmp alltraps
80105f63:	e9 22 f7 ff ff       	jmp    8010568a <alltraps>
...
80105f6a:	6a 79                	push   $0x79
  jmp alltraps
80105f6c:	e9 19 f7 ff ff       	jmp    8010568a <alltraps>
...
80105f73:	6a 7a                	push   $0x7a
  jmp alltraps
80105f75:	e9 10 f7 ff ff       	jmp    8010568a <alltraps>
...
80105f7c:	6a 7b                	push   $0x7b
  jmp alltraps
80105f7e:	e9 07 f7 ff ff       	jmp    8010568a <alltraps>
...
80105f85:	6a 7c                	push   $0x7c
  jmp alltraps
80105f87:	e9 fe f6 ff ff       	jmp    8010568a <alltraps>
...
80105f8e:	6a 7d                	push   $0x7d
  jmp alltraps
80105f90:	e9 f5 f6 ff ff       	jmp    8010568a <alltraps>
...
80105f97:	6a 7e                	push   $0x7e
  jmp alltraps
80105f99:	e9 ec f6 ff ff       	jmp    8010568a <alltraps>
...
80105fa0:	6a 7f                	push   $0x7f
  jmp alltraps
80105fa2:	e9 e3 f6 ff ff       	jmp    8010568a <alltraps>
...
80105fb5:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80105fba:	e9 cb f6 ff ff       	jmp    8010568a <alltraps>
...
80105fc1:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80105fc6:	e9 bf f6 ff ff       	jmp    8010568a <alltraps>
...
8010660a:	e8 01 df ff ff       	call   80104510 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106773:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106776:	e8 d5 d0 ff ff       	call   80103850 <cpuid>
  pd[0] = size-1;
...
80106834:	0f 84 c2 00 00 00    	je     801068fc <switchuvm+0xec>
  pushcli();
8010683a:	e8 11 db ff ff       	call   80104350 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
8010683f:	e8 9c cf ff ff       	call   801037e0 <mycpu>
80106844:	89 c3                	mov    %eax,%ebx
80106846:	e8 95 cf ff ff       	call   801037e0 <mycpu>
8010684b:	89 c7                	mov    %eax,%edi
8010684d:	e8 8e cf ff ff       	call   801037e0 <mycpu>
80106852:	83 c7 08             	add    $0x8,%edi
80106855:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106858:	e8 83 cf ff ff       	call   801037e0 <mycpu>
...
801068e9:	5d                   	pop    %ebp
  popcli();
801068ea:	e9 71 db ff ff       	jmp    80104460 <popcli>
...
8010694f:	e8 bc db ff ff       	call   80104510 <memset>
...
80106982:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106983:	e9 28 dc ff ff       	jmp    801045b0 <memmove>
    panic("inituvm: more than a page");
80106988:	83 ec 0c             	sub    $0xc,%esp
8010698b:	68 ed 77 10 80       	push   $0x801077ed
...
80106aab:	e8 60 da ff ff       	call   80104510 <memset>
...
80106ae9:	68 25 78 10 80       	push   $0x80107825
...
80106b4b:	68 3d 78 10 80       	push   $0x8010783d
...
80106c60:	e8 ab d8 ff ff       	call   80104510 <memset>
...
80106ccb:	a3 a4 55 11 80       	mov    %eax,0x801155a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106d53:	e8 58 d8 ff ff       	call   801045b0 <memmove>
...
80106dd7:	68 74 78 10 80       	push   $0x80107874
80106ddc:	e8 9f 95 ff ff       	call   80100380 <panic>
      panic("copyuvm: page not present");
80106de1:	83 ec 0c             	sub    $0xc,%esp
80106de4:	68 8e 78 10 80       	push   $0x8010788e
...
80106e66:	e8 45 d7 ff ff       	call   801045b0 <memmove>
    len -= n;
    buf += n;
