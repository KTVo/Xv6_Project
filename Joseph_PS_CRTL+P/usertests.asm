...
00000d90 <mem>:
{
  ...
  ppid = getpid();
     da7:	e8 a7 2b 00 00       	call   3953 <getpid>
     dac:	89 c6                	mov    %eax,%esi
  if((pid = fork()) == 0){
     dae:	e8 18 2b 00 00       	call   38cb <fork>
    ...
    exit();
     ...
     e4e:	5d                   	pop    %ebp
    wait();
     e4f:	e9 87 2a 00 00       	jmp    38db <wait>
    ...
    102b:	31 db                	xor    %ebx,%ebx
{
  ...
  for(i = 0; i < 2; i++){
    ...
    10af:	e8 5f 28 00 00       	call   3913 <open>
    while((n = read(fd, buf, sizeof(buf))) > 0){
  ...
  printf(1, "fourfiles ok\n");
    ...
    115f:	e8 dc 28 00 00       	call   3a40 <printf>
          exit();
    1164:	e8 6a 27 00 00       	call   38d3 <exit>
      fd = open(fname, O_CREATE | O_RDWR);
    1169:	83 ec 08             	sub    $0x8,%esp
    116c:	68 02 02 00 00       	push   $0x202
    1171:	56                   	push   %esi
    1172:	e8 9c 27 00 00       	call   3913 <open>
      if(fd < 0){
    ...
    11ab:	56                   	push   %esi
    11ac:	e8 42 27 00 00       	call   38f3 <write>
    ...
    11be:	75 de                	jne    119e <fourfiles+0x17e>
      exit();
    11c0:	e8 0e 27 00 00       	call   38d3 <exit>
    ...
    11ce:	e8 6d 28 00 00       	call   3a40 <printf>
        exit();
    11d3:	e8 fb 26 00 00       	call   38d3 <exit>
    ...
    11ea:	e8 51 28 00 00       	call   3a40 <printf>
      exit();
    11ef:	e8 df 26 00 00       	call   38d3 <exit>
    ...
    11fd:	e8 3e 28 00 00       	call   3a40 <printf>
      exit();
    1202:	e8 cc 26 00 00       	call   38d3 <exit>
    ...
    1210:	e8 2b 28 00 00       	call   3a40 <printf>
          exit();
    1215:	e8 b9 26 00 00       	call   38d3 <exit>
    ...
    1226:	31 db                	xor    %ebx,%ebx
{
  ...
  for(i = 0; i < N; i++){
    ...
    12cf:	50                   	push   %eax
    12d0:	e8 26 26 00 00       	call   38fb <close>
  ...
  printf(1, "createdelete ok\n");
    ...
    1384:	88 45 c9             	mov    %al,-0x37(%ebp)
        fd = open(name, O_CREATE | O_RDWR);
    1387:	e8 87 25 00 00       	call   3913 <open>
        if(fd < 0){
    ...
    1396:	50                   	push   %eax
    1397:	e8 5f 25 00 00       	call   38fb <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    13b3:	88 45 c9             	mov    %al,-0x37(%ebp)
          if(unlink(name) < 0){
    13b6:	e8 68 25 00 00       	call   3923 <unlink>
    ...
    13cb:	e8 70 26 00 00       	call   3a40 <printf>
            exit();
    13d0:	e8 fe 24 00 00       	call   38d3 <exit>
    13d5:	8d 76 00             	lea    0x0(%esi),%esi
      exit();
    13d8:	e8 f6 24 00 00       	call   38d3 <exit>
    ...
    13e8:	e8 53 26 00 00       	call   3a40 <printf>
        exit();
    13ed:	e8 e1 24 00 00       	call   38d3 <exit>
          printf(1, "create failed\n");
    ...
    13fc:	e8 3f 26 00 00       	call   3a40 <printf>
          exit();
    1401:	e8 cd 24 00 00       	call   38d3 <exit>
      printf(1, "fork failed\n");
    ...
    1410:	e8 2b 26 00 00       	call   3a40 <printf>
      exit();
    1415:	e8 b9 24 00 00       	call   38d3 <exit>
      } else if((i >= 1 && i < N/2) && fd >= 0){
    ...
    142b:	e8 10 26 00 00       	call   3a40 <printf>
        exit();
    1430:	e8 9e 24 00 00       	call   38d3 <exit>
    ...
    17ea:	31 f6                	xor    %esi,%esi
{
  ...
  for(i = 0; i < 40; i++){
    ...
    182e:	53                   	push   %ebx
    182f:	e8 df 20 00 00       	call   3913 <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    183e:	83 c6 01             	add    $0x1,%esi
      close(fd);
    1841:	50                   	push   %eax
    1842:	e8 b4 20 00 00       	call   38fb <close>
    1847:	83 c4 10             	add    $0x10,%esp
      wait();
    184a:	e8 8c 20 00 00       	call   38db <wait>
  for(i = 0; i < 40; i++){
    ...
    unlink(file);
    1862:	e8 bc 20 00 00       	call   3923 <unlink>
    pid = fork();
    1867:	e8 5f 20 00 00       	call   38cb <fork>
    if(pid && (i % 3) == 1){
    ...
    1891:	53                   	push   %ebx
    1892:	e8 7c 20 00 00       	call   3913 <open>
      if(fd < 0){
    ...
    18ad:	e8 8e 21 00 00       	call   3a40 <printf>
        exit();
    18b2:	e8 1c 20 00 00       	call   38d3 <exit>
  ...
  for(i = 0; i < 40; i++){
    ...
    pid = fork();
    19e8:	e8 de 1e 00 00       	call   38cb <fork>
    ...
    1a10:	6a 00                	push   $0x0
    1a12:	53                   	push   %ebx
    1a13:	e8 fb 1e 00 00       	call   3913 <open>
    1a18:	89 04 24             	mov    %eax,(%esp)
    1a1b:	e8 db 1e 00 00       	call   38fb <close>
      close(open(file, 0));
    1a20:	58                   	pop    %eax
    1a21:	5a                   	pop    %edx
    1a22:	6a 00                	push   $0x0
    1a24:	53                   	push   %ebx
    1a25:	e8 e9 1e 00 00       	call   3913 <open>
    1a2a:	89 04 24             	mov    %eax,(%esp)
    1a2d:	e8 c9 1e 00 00       	call   38fb <close>
      close(open(file, 0));
    1a32:	59                   	pop    %ecx
    1a33:	58                   	pop    %eax
    1a34:	6a 00                	push   $0x0
    1a36:	53                   	push   %ebx
    1a37:	e8 d7 1e 00 00       	call   3913 <open>
    1a3c:	89 04 24             	mov    %eax,(%esp)
    1a3f:	e8 b7 1e 00 00       	call   38fb <close>
      close(open(file, 0));
    1a44:	58                   	pop    %eax
    1a45:	5a                   	pop    %edx
    1a46:	6a 00                	push   $0x0
    1a48:	53                   	push   %ebx
    1a49:	e8 c5 1e 00 00       	call   3913 <open>
    1a4e:	89 04 24             	mov    %eax,(%esp)
    1a51:	e8 a5 1e 00 00       	call   38fb <close>
...
00001ae0 <linkunlink>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1b72:	e8 9c 1d 00 00       	call   3913 <open>
    1b77:	89 04 24             	mov    %eax,(%esp)
    1b7a:	e8 7c 1d 00 00       	call   38fb <close>
  ...
  if(pid)
    ...
    wait();
    1b8e:	e8 48 1d 00 00       	call   38db <wait>
    ...
    2d44:	31 ff                	xor    %edi,%edi
{
  ...
  a = sbrk(0);
    2d70:	e8 e6 0b 00 00       	call   395b <sbrk>
  ...
  *lastaddr = 99;
  ...
  c = sbrk(-(sbrk(0) - oldbrk));
    ...
    2ec0:	e8 96 0a 00 00       	call   395b <sbrk>
  if(c != a){
  ...
  if(pipe(fds) != 0){
    ...
    if((pids[i] = fork()) == 0){
    2f21:	e8 a5 09 00 00       	call   38cb <fork>
    ...
    2f41:	e8 a5 09 00 00       	call   38eb <read>
  ...
  c = sbrk(4096);
    ...
    2f5b:	e8 fb 09 00 00       	call   395b <sbrk>
    ...
    2f6f:	50                   	push   %eax
    2f70:	e8 8e 09 00 00       	call   3903 <kill>
    wait();
    2f75:	e8 61 09 00 00       	call   38db <wait>
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    3011:	e8 45 09 00 00       	call   395b <sbrk>
    ...
    3034:	e8 9a 08 00 00       	call   38d3 <exit>
    ...
    exit();
    304b:	e8 83 08 00 00       	call   38d3 <exit>
    printf(1, "pipe() failed\n");
    3050:	52                   	push   %edx
    3051:	52                   	push   %edx
    ...
    exit();
    305e:	e8 70 08 00 00       	call   38d3 <exit>
    ...
    3080:	e8 7e 08 00 00       	call   3903 <kill>
      exit();
    3085:	e8 49 08 00 00       	call   38d3 <exit>
      printf(stdout, "fork failed\n");
    ...
    exit();
    3110:	e8 be 07 00 00       	call   38d3 <exit>
    ...
    exit();
    3127:	e8 a7 07 00 00       	call   38d3 <exit>
    exit();
    312c:	e8 a2 07 00 00       	call   38d3 <exit>
    ...
    exit();
    3143:	e8 8b 07 00 00       	call   38d3 <exit>
    ...
    exit();
    315a:	e8 74 07 00 00       	call   38d3 <exit>
    315f:	90                   	nop
...
00003170 <validatetest>:
{
  ...
  printf(stdout, "validate test\n");
    ...
    if((pid = fork()) == 0){
    3190:	e8 36 07 00 00       	call   38cb <fork>
    ...
    319e:	6a 00                	push   $0x0
    31a0:	e8 be 07 00 00       	call   3963 <sleep>
    sleep(0);
    31a5:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    31ac:	e8 b2 07 00 00       	call   3963 <sleep>
    kill(pid);
    31b1:	89 34 24             	mov    %esi,(%esp)
    31b4:	e8 4a 07 00 00       	call   3903 <kill>
    wait();
    31b9:	e8 1d 07 00 00       	call   38db <wait>
    if(link("nosuchfile", (char*)p) != -1){
    31be:	58                   	pop    %eax
    31bf:	5a                   	pop    %edx
    31c0:	53                   	push   %ebx
    31c1:	68 5d 4c 00 00       	push   $0x4c5d
    31c6:	e8 68 07 00 00       	call   3933 <link>
  ...
  printf(stdout, "validate ok\n");
    ...
    31fd:	c3                   	ret    
      exit();
    31fe:	e8 d0 06 00 00       	call   38d3 <exit>
    ...
    3211:	e8 2a 08 00 00       	call   3a40 <printf>
      exit();
    3216:	e8 b8 06 00 00       	call   38d3 <exit>
